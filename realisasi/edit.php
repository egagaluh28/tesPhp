...
<? 
	     ...
	     $qry = mysql_query("select * from realisasi where id_realisasi='$_GET[id_realisasi]' and id_pagu='$_GET[id_pagu]' ");
...
<form name="form1"  method="POST"  action="realisasi/proses.php?aksi=ubah">
  <table align="center" width="100%"   cellpadding="3" >
 	 
    <tr> <td valign="middle"  align="right" class="subyek1"></td>
		<td  align="left" colspan="2"> 
		  
			<input name="id_pagu" type="hidden" value="<? echo "$row[id_pagu]";  ?>"  readonly class="input-field"/>
	        <input name="id_realisasi" type="hidden"    value="<? echo "$row[id_realisasi]"; ?>" readonly class="input-field">
			<input name="kdkotama" type="hidden" value="<? echo "$row[kdkotama]";  ?>"  readonly class="input-field"/>
			<input name="kdsatker" type="hidden" value="<? echo "$row[kdsatker]";  ?>"  readonly class="input-field"/>
	...
	<tr>
      ...
      <td  align="left"> <input name="nospp" type="text" size="12" class="input-field"  autocomplete="off" value="<? echo "$row[nospp]";?>" /></td>
   
	   <td valign="middle"  align="right" class="subyek1">NOMOR SP2D : </td>
      <td  align="left"> <input name="nosp2d" type="text"  class="input-field"  size="12" autocomplete="off" value="<? echo "$row[nosp2d]";?>" /></td>
	...
	<tr>
      ...
      <td  align="left"><? print "<input name='nilai_spp' type='hidden' size='15' value='$row[nilai_spp]' class='input-field' style='text-align: right;' />
      ...
      <td  align="left"><? print "<input name='realisasi' type='text'  size='15' value='$row[realisasi]' class='input-field' style='text-align: right;' />
	...
	<tr>
      ...
      <td  align="left"> <input name="nospm" type="text"  class="input-field"  value="<? echo "$row[nospm]";?>" autocomplete="off"/></td>
	...
	<tr>
	  ...
	  <td><?php print "<input name='nilai_spm' type='hidden'  value='$row[nilai_spm]' size='15' class='input-field' style='text-align: right;' />
