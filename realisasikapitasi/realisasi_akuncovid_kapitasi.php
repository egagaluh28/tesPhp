...
//        pakai ini
            ...
            $reload = "media.php?module=realisasi_akuncovid_kapitasi&thang=$_GET[thang]&pagination=true&keyword=$keyword";
            $result =  mysql_query("select z.* from(SELECT  a.id_pagu, a.kdkotama, a.kdsatker, a.thang, a.kdakun, a.nmakun, a.nmitem, 
sum(a.pagu) as pagu, sum(a.revisi) as revisi, sum(a.pagurevisi) as pagurevisi,    c.blnlalu, d.blnini FROM kapitasi a 

left join (select  id_pagu, kdakun,  kdkotama, kdsatker, thang, sum(realisasi) as blnlalu from realisasi_kapitasi where kdbulan='$_GET[kdbulan]' and kdkotama='$_SESSION[kdkotama]' and kdsatker='$_SESSION[kdsatker]' and thang='$_GET[thang]' and kdakun='521131' group by id_pagu) as c on   a.id_pagu=c.id_pagu 

left join (select  id_pagu, kdakun,  kdkotama, kdsatker, thang, sum(realisasi) as  blnini from realisasi_kapitasi where kdbulan='$_GET[kdbulan]' and kdkotama='$_SESSION[kdkotama]' and kdsatker='$_SESSION[kdsatker]' and thang='$_GET[thang]' and kdakun='521131' group by id_pagu) as d on   a.id_pagu=d.id_pagu 

where  a.kdkotama='$_SESSION[kdkotama]' and a.kdsatker='$_SESSION[kdsatker]' and a.thang='$_GET[thang]' and a.kdakun='521131'  group by a.id_pagu) as z 
			WHERE z.kdakun LIKE '%$keyword%' or z.nmitem LIKE '%$keyword%' ORDER BY z.id_pagu");
			
        }else{
//            jika tidak ada pencarian pakai ini
            $reload = "media.php?module=realisasi_akuncovid_kapitasi&thang=$_GET[thang]&pagination=true";
            $result =  mysql_query("SELECT  a.id_pagu, a.kdkotama, a.kdsatker, a.thang, a.kdakun, a.nmakun, a.nmitem, 
sum(a.pagu) as pagu, sum(a.revisi) as revisi, sum(a.pagurevisi) as pagurevisi,    c.blnlalu, d.blnini FROM kapitasi a 
...
where  a.kdkotama='$_SESSION[kdkotama]' and a.kdsatker='$_SESSION[kdsatker]' and a.thang='$_GET[thang]' and a.kdakun='521131'  group by a.id_pagu order by a.id_pagu");
...
<table  width='98%' align='center'>
    <tr>
		 ...
		 <form name='form1' method='GET'  action='realisasikapitasi/kirimparameter_akuncovid.php' >
	...
	print "&nbsp;&nbsp;<a href='cetak/cetak_akuncovid_kapitasi.php?kdbulan=$_GET[kdbulan]&thang=$_GET[thang]&kdkotama=$_SESSION[kdkotama]&kdsatker=$_SESSION[kdsatker]' target='_blank' style='text-decoration:none'><input  type='button' value='Cetak' class='button2'/></a>";
	?> 
		...
		<td align="right">
			...
			<a href="<?php print "media.php?module=realisasi_akuncovid_kapitasi&thang=$_GET[thang]&kdbulan=$_GET[kdbulan]"; ?>"
