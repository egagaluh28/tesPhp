...
//        pakai ini
            ...
            $reload = "media.php?module=rekap_akun_bpjs_satker&thang=$_GET[thang]&pagination=true&keyword=$keyword";
...
FROM bpjs a 
left join (select kdgiat, kdoutput, kdakun,  kdkotama, kdsatker, thang, sum(realisasi) as blnlalu from realisasi_bpjs where kdbulan<'$_GET[kdbulan]' and kdkotama='$_SESSION[kdkotama]' and kdsatker='$_SESSION[kdsatker]' and thang='$_GET[thang]' group by  kdakun) as c on   a.kdakun=c.kdakun 
left join (select kdgiat, kdoutput, kdakun,  kdkotama, kdsatker, thang, sum(realisasi) as  blnini from realisasi_bpjs where kdbulan='$_GET[kdbulan]' and kdkotama='$_SESSION[kdkotama]' and kdsatker='$_SESSION[kdsatker]' and thang='$_GET[thang]' group by  kdakun) as d on   a.kdakun=d.kdakun 
...
//            jika tidak ada pencarian pakai ini
            $reload = "media.php?module=rekap_akun_bpjs_satker&thang=$_GET[thang]&pagination=true";
...
<table  width='98%' align='center'>
    <tr>
		 ...
		 <form name='form1' method='GET'  action='realisasibpjs/kirimparameter_rekapakun.php' >
	...
	print "&nbsp;&nbsp;<a href='cetak/cetak_rekapakun_bpjs_satker.php?kdbulan=$_GET[kdbulan]&thang=$_GET[thang]&kdkotama=$_SESSION[kdkotama]&kdsatker=$_SESSION[kdsatker]' target='_blank' style='text-decoration:none'><input  type='button' value='Cetak' class='button2'/></a>";
	?> 
		...
		<td align="right">
			...
			<a href="<?php print "media.php?module=rekap_akun_bpjs_satker&thang=$_GET[thang]&kdbulan=$_GET[kdbulan]"; ?>"
