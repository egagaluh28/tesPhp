...
background: -moz-linear-gradient(-45deg, rgba(34, 139, 34, 1.0) 0%, rgba(47, 244, 79, 1.0) 100%);
background: -webkit-gradient(left top, right bottom, color-stop(0%, rgba(34, 139, 34, 1.0)), color-stop(100%, rgba(47, 244, 79, 1.0)));
background: -webkit-linear-gradient(-45deg, rgba(34, 139, 34, 1.0) 0%, rgba(47, 244, 79, 1.0) 100%);
background: -o-linear-gradient(-45deg, rgba(34, 139, 34, 1.0) 0%, rgba(47, 244, 79, 1.0) 100%);
background: -ms-linear-gradient(-45deg, rgba(34, 139, 34, 1.0) 0%, rgba(47, 244, 79, 1.0) 100%);
background: linear-gradient(135deg, rgba(34, 139, 34, 1.0) 0%, rgba(47, 244, 79, 1.0) 100%);
...
<div class='box'>
  <div class='box-form'>
    <div class='box-login-tab'></div><form class="login" method="POST" action="pr0s3sl0g1nphp.php">
    <div class='box-login-title'>
      <div class='i i-login'></div><h2>LAPLAKGAR  &nbsp;2023</h2>
    </div>
    <div class='box-login'>
      
	  <div class='fieldset-body' id='login_form'>
	  <br><br><img src="images/ad.png" width="80"><br>
      <!--  <button onclick="openLoginInfo();" class='b b-form i i-more' title='Mais Informações'></button> -->
        	<p class='field'>
          <label for='user'>USERNAME</label>
          <input type='text' id='user' name='usernamelaplakgar' title='Username' autocomplete="off"/>
          <span id='valida' class='i i-warning'></span>
        </p>
      	  <p class='field'>
          <label for='pass'>PASSWORD</label>
          <input type='password' id='pass' name='passwordlaplakgar' title='Password' autocomplete="off"/>
          <span id='valida' class='i i-close'></span>
        </p>

       

        	<input type='submit' id='do_login' value='L O G I N' title='Get Started' />
      </div>
