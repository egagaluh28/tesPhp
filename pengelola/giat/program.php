...
<html>
	...
	<br><center><span class='judulcontent'>TABEL PROGRAM</span></center><br>
...
//        pakai ini
            ...
            $reload = "media.php?module=program&pagination=true&keyword=$keyword";
            $result =  mysql_query("SELECT * from t_program 
			WHERE kdprogram LIKE '%$keyword%' or nmprogram LIKE '%$keyword%' ORDER BY kdprogram");
			
        }else{
//            jika tidak ada pencarian pakai ini
            $reload = "media.php?module=program&pagination=true";
            $result =  mysql_query("SELECT * FROM t_program ORDER BY kdprogram");
...
<table  width='60%' align='center'>
    <tr>
		...
		<td align="right">
			...
			<a href="<?php print "media.php?module=program&thang=$_GET[thang]"; ?>"
	...
	<tr>
            ...
            <table class="bordered" width="60%" align="center">
                <thead>
                    <tr>
 ...
 ?>             
					...
					<tr>
						...
						<td valign="top" align="center"><?php print $data['kdprogram']?></a> </td>
							<td valign="top" ><?php print $data['nmprogram']?></td>
