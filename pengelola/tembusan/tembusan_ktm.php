...
<form  method="POST"  name="form1" action="pengelola/tembusan/proses.php?aksi=simpanktm">  
    ...
    <table width="80%" align="center" cellpadding="5">
			...
			<tr>
			    ...
			    <td><input name='urut'  type='text' size='4' class='select-field' required >&nbsp;
					...
					<input type="hidden"  name="kdsatker"  value=<? print "000000"; ?> />
...
<?php
	...
	$sql="SELECT * FROM tembusan  where kdkotama='$_SESSION[kdkotama]' and kdsatker='000000' and urut<>'99' order by urut"; 
    $qry=mysql_query($sql);
    ...
    print "<td ><a href='pengelola/tembusan/editktm.php?&idtembusan=$row[idtembusan]&width=800&height=350' class='thickbox' data-tooltip='Edit Tembusan' data-position='top'><img src='images/edit.png' width='20' ></a></td>";
	print"<td  align='center' valign='top'><a href=\"pengelola/tembusan/proses.php?aksi=hapusktm&idtembusan=$row[idtembusan]\" onClick=\"return confirm('APAKAH ANDA AKAN MENGHAPUS TEMBUSAN ~ $row[nama] ~ ? ')\" data-tooltip='Hapus Tembusan' data-position='top'><img src='images/delete.png' width='20' title='Delete'></td>"; 
    $no++;
	 ...
	 $edit = mysql_query("SELECT count(urut) as jurut, idtembusan, kdkotama, kdsatker, urut, nama FROM tembusan  where kdkotama='$_SESSION[kdkotama]' and kdsatker='000000' and urut='99'  group by urut");
     $data    = mysql_fetch_array($edit);


if ($data[jurut]>'0') {
print "<form action='pengelola/tembusan/proses.php?aksi=ubahgarisktm' method='POST'  name='form1'>";  	
} else {
print "<form action='pengelola/tembusan/proses.php?aksi=simpangarisktm' method='POST'  name='form1'>"; 	
}	
