...
//        pakai ini
            ...
            $reload = "media.php?module=ttd&pagination=true&keyword=$keyword";
            $result =  mysql_query("select z.* from(SELECT a.*, b.nmbulan FROM tajuk_ttd a left join t_bulan b on a.kdbulan=b.kdbulan 
			where kdkotama='$_SESSION[kdkotama]' and kdsatker='$_SESSION[kdsatker]') as z	
			WHERE z.nmbulan LIKE '%$keyword%' or z.thang LIKE '%$keyword%' or z.pkt_crp  LIKE '%$keyword%' or z.nama LIKE '%$keyword%' ORDER BY z.kdbulan, z.thang");
			
        }else{
//            jika tidak ada pencarian pakai ini
            $reload = "media.php?module=ttd&pagination=true";
            $result =  mysql_query("SELECT a.*, b.nmbulan FROM tajuk_ttd a left join t_bulan b on a.kdbulan=b.kdbulan 
...
<table  width='99%' align='center'>
    <tr>
		...
		<a href="<?php print "media.php?module=inputttd"; ?>"  style="text-decoration:none">
		...
		<td align="right">
			...
			<a href="<?php print "media.php?module=ttd"; ?>" style="text-decoration:none">
...
<table class="bordered" width="99%" align="center">
    ...
    <tr>
		...
		<th align="center" >PEJABAT 1</th>
		<th align="center" >NAMA</th>
		<th align="center" >PANGKAT/CORP</th>
    ...
    <tr>
		...
		<td  valign="top"><?php echo $data['an']; ?></td>
		<td  valign="top"><?php echo $data['pejabat1']; ?></td>
		<td  valign="top"><?php echo $data['nama']; ?></td>				
		<td  valign="top" ><?php echo $data['pkt_crp']; ?></td>
			
						
        <td valign="top" align="center">
		<?php print "<a href='media.php?module=editttd&id=$data[id]' class='top'>"; ?>
		<span tooltip='Ubah Data'><img src="images/edit.png" width="22" ></span></a></td>
		<td valign="top" align="center"><?php print "<a href=\"pengelola/ttd/proses.php?aksi=hapus&id=$data[id]\" 
     onClick=\"return confirm('APAKAH ANDA AKAN MENGHAPUS  ~ $data[nama] ~? ')\" >
