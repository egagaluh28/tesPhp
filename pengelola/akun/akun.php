...
<html>
	...
	<br><center><span class='judulcontent'>TABEL AKUN</span></center><br>
...
//        pakai ini
            ...
            $reload = "media.php?module=akun&pagination=true&keyword=$keyword";
            $result =  mysql_query("SELECT * from t_akun 
			WHERE kdakun LIKE '%$keyword%' or nmakun LIKE '%$keyword%' ORDER BY kdakun");
			
        }else{
//            jika tidak ada pencarian pakai ini
            $reload = "media.php?module=akun&pagination=true";
            $result =  mysql_query("SELECT * FROM t_akun ORDER BY kdakun");
...
<table  width='80%' align='center'>
    <tr>
		...
		<td align='left'><div class='codehim-tombol-biru' ><a href='media.php?module=inputakun' style="text-decoration:none"><input type="button" value="Tambah Akun"  ></a></div></td>
		...
		<td align="right">
			...
			<a href="<?php print "media.php?module=akun&thang=$_GET[thang]"; ?>"
            ...
            <table class="bordered" width="80%" align="center">
                <thead>
                    <tr>
						...
						<th   align='center' >KODE 	JENBEL</th>
 ...
 ?>             
					...
					<tr>
						...
						<td valign="top" align="center"><?php print $data['kdjenbel']?></a> </td>
						<td valign="top" align="center"><?php print $data['kdakun']?></a> </td>
						<td valign="top" ><?php print $data['nmakun']?></td>
						<?php print "<td  align='center' valign='top'><a href='media.php?module=editakun&id=$data[id]'>
			  <img src='images/edit.png' width='20' title='Edit'></a></td>
			  <td  align='center' valign='top'><a href=\"pengelola/akun/proses.php?aksi=hapus&id=$data[id]\" onClick=\"return confirm('APAKAH ANDA AKAN MENGHAPUS  ~ $data[kdakun] ~? ')\" ><img src='images/delete.png' width='20' title='Delete'></td>";?>	
