...
<? 
	...
	$ambil=mysql_query("select * from surat where  idsurat='888888888888888888'");
...
<br>
<center><span class="judulcontent">INPUT SURAT</span></center><br>
<center><div id="borderku1" > 
 <div class="form-style-2">
  <form  name="form1" method="post" action="pengelola/surat/proses.php?aksi=simpanktm"> 
  ...
  <input name="kdsatker" type="hidden"  <? print "value='000000'"; ?>  class="input-field" size="50"/>
    <tr>
