...
<table width="50%" align="center" >
			<tr><td align="center">
			<? print "<a href='cetak/cetak_surat_sbsn.php?idsurat=$_GET[idsurat]&kdbulan=$isi[kdbulan]&thang=$isi[thang]&kdkotama=$isi[kdkotama]&kdsatker=$isi[kdsatker]' target='_blank'>"; ?>
			<input class="button-3d" type="submit" name="backup"  value="CETAK SURAT" /></a></td>
			
			<td align="center">
			<? print "<a href='media.php?module=editsuratdetail&idsurat=$_GET[idsurat]' >"; ?>
			<input class="button-3d" type="submit" name="backup"  value="UBAH SURAT" /></a></td>
			
			<td align="center">
			<? print "<a href='media.php?module=surat_satker' >"; ?>
