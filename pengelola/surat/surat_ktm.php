...
<table  width='98%' align='center'>
    <tr>
	    <td><a href='media.php?module=inputsurat_ktm' style='text-decoration:none'><div class='codehim-tombol-biru'><input  type='button' value='Tambah Surat' /></div></a>
		</td>
 ...
 ?>             
			  ...
			  <td valign='top'><a href='media.php?module=detailsurat_ktm&idsurat=$data[idsurat]' data-tooltip='Detail Surat' data-position='top' class='top' style='text-decoration:none'>$data[nomor]</a></td>
			  ...
			  <td  align='center' valign='top'><a href='media.php?module=editsurat_ktm&idsurat=$data[idsurat]' data-tooltip='Edit Surat' data-position='top' class='top'>
			  <img src='images/edit.png' width='20' ></a></td>
			  <td  align='center' valign='top'><a href=\"pengelola/surat/proses.php?aksi=hapusktm&idsurat=$data[idsurat]\" onClick=\"return confirm('APAKAH ANDA AKAN MENGHAPUS SURAT ~ $data[nomor] ~? ')\" data-tooltip='Hapus Surat' data-position='top' class='top'><img src='images/delete.png' width='20' ></td>			  
