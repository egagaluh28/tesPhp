...
#borderku{
 ...
 <br>
 <br><table  width='1100' align='center' ><tr><td class='judulcontent' align='center'>CETAK DIPA DAERAH TINGKAT SATKER</td></tr></table>

 <br><center><div id="borderku" >
 <div class="form-style-2">
  <div class='codehim-tombol-biru'>
 <?php
 print "<form name='form1' method='GET'  action='cetak/cetak_daerah_satker_jenbel.php' target='_Blank'>";
 ...
 print "<input type='hidden'  name='kdsatker'  size='5' class='rounded' readonly value='$_SESSION[kdsatker]'>"; 
	print "<table width='85%'  cellspacing='0' cellpadding='2' align='center'><tr><td class='subyek1'>BULAN : ";
...
<br><table  width='1100' align='center' ><tr><td class='judulcontent' align='center'>CETAK DIPA DAERAH TINGKAT SATKER (PLUS SBSN)</td></tr></table>
 ...
 print "<form name='form1' method='GET'  action='cetak/cetak_daerah_satker_jenbel_sbsn.php' target='_Blank'>";
 print "<input type='hidden'  name='kdkotama'  size='5' class='rounded' readonly value='$_SESSION[kdkotama]'>"; 
 print "<input type='hidden'  name='kdsatker'  size='5' class='rounded' readonly value='$_SESSION[kdsatker]'>"; 
	print "<table width='85%'  cellspacing='0' cellpadding='2' align='center'><tr><td class='subyek1'>BULAN : ";
	print "<select name='kdbulan'  class='select-field' required='required'>";
...
<!--	
<br><table  width='1100' align='center' ><tr><td class='judulcontent' align='center'>CETAK DIPA DAERAH TINGKAT SATKER (BENTUK LAMA)</td></tr></table>
<br><center><div id="borderku" >
 <div class="form-style-2"> -->
 <? /*
 print "<form name='form1' method='GET'  action='cetaklama/cetak_daerah_satker.php' target='_Blank'>";
 print "<input type='hidden'  name='kdkotama'  size='5' class='rounded' readonly value='$_SESSION[kdkotama]'>"; 
 print "<input type='hidden'  name='kdsatker'  size='5' class='rounded' readonly value='$_SESSION[kdsatker]'>"; 
	print "<table width='85%'  cellspacing='0' cellpadding='2' align='center'><tr><td class='subyek1'>BULAN : ";
	print "<select name='kdbulan'  class='select-field' required='required'>";
