...
#borderku{
 ...
 <br>
 <br><table  width='1100' align='center' ><tr><td class='judulcontent' align='center'>CETAK MONITORING DIPA DAERAH PER WASGIAT</td></tr></table>

 <br><center><div id="borderku" >
 <div class="form-style-2">
 <?
 print "<form name='form1' method='GET'  action='cetak/cetak_mon_daerah_satker_wasgiat.php' target='_Blank'>"; ?>
<?	print "<table width='90%'  cellspacing='0' cellpadding='2' align='center'><tr><td class='subyek1' align='center'>WASGIAT : ";
	...
	print "<select name='kdwasgiat'  class='select-field' >";
