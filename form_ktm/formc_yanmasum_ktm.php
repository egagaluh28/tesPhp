...
#borderku{
 ...
 <br>
 <br><table  width='1100' align='center' ><tr><td class='judulcontent' align='center'>CETAK DIPA DAERAH (PNBP YANMASUM) TINGKAT KOTAMA</td></tr></table>

 <br><center><div id="borderku" >
 <div class="form-style-2">
 <?
 print "<div class='codehim-tombol-biru'><form name='form1' method='GET'  action='cetak/cetak_yanmasum_ktm.php' target='_Blank'>";
 ...
 print "<input type='hidden'  name='kdsatker'  size='5' class='rounded' readonly value='$_SESSION[kdsatker]'>"; 
	print "<table width='75%'  cellspacing='0' cellpadding='2' align='center'><tr><td class='subyek1'>BULAN : ";
