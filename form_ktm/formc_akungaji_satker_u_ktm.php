...
font-family: Cambria, Palatino, "Palatino Linotype", "Palatino LT STD", Georgia, serif;
 ...
 print "<div class='codehim-tombol-biru'><form name='form1' method='GET'  action='cetak/cetak_akungaji_satker.php' target='_blank'>";
 
    print "<table width='97%' align='center' cellpadding='3'  >";
	print "<tr>";
