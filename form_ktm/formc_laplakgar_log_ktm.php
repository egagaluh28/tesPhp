...
#borderku{
 ...
 <?
 print "<form name='form1' method='GET'  action='cetak/cetak_laplakgar_log_ktm.php' target='_Blank'>";
 print "<div class='codehim-tombol-biru'><input type='hidden'  name='kdkotama'  size='5' class='rounded' readonly value='$_SESSION[kdkotama]'>"; 
