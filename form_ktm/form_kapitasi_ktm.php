...
#borderku{
 ...
 <?
 print "<div class='codehim-tombol-biru'><form name='form1' method='GET'  action='realisasikapitasi/kirimparameter_ktm.php' >";
	print "<table width='70%'  cellspacing='0' cellpadding='2' align='center'><tr><td class='subyek1'>BULAN : ";
