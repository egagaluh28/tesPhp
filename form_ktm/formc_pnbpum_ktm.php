...
#borderku{
 ...
 <br><table  width='1100' align='center' ><tr><td class='judulcontent' align='center'>CETAK PNBP UMUM</td></tr></table>

 <br><center><div id="borderku" >
  <div class="form-style-2">
 <?
 print "<form name='form1' method='GET'  action='cetak/cetak_pnbpum_ktm.php' target='_Blank'>";
...
// print "<input type='hidden'  name='kdsatker'  size='5' class='rounded' readonly value='$_SESSION[kdsatker]'>"; 
	print "<table width='85%'  cellspacing='0' cellpadding='2' align='center'><tr><td class='subyek1'>TRIWULAN : ";
