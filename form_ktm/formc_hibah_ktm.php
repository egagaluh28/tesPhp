...
#borderku{
 ...
 <br>
 <br><table  width='1100' align='center' ><tr><td class='judulcontent' align='center'>CETAK HIBAH TINGKAT KOTAMA</td></tr></table>

 <br><center><div id="borderku" >
 <div class="form-style-2">
 <?
 print "<div class='codehim-tombol-biru'><form name='form1' method='GET'  action='cetak/cetak_hibah_ktm.php' target='_Blank'>";
