...
font-family: 'arial',  sans-serif;
 ...
 <center><br><span class='judulcontent'>CETAK LAPLAKGAR BPJS TINGKAT SATKER</span></center><br><br>
 
 <center>
 <?
  print "<div id='borderku' ><div class='form-style-2'>";
  
 print "<div class='codehim-tombol-biru'><form name='form1' method='GET'  action='cetak/cetak_mon_bpjs_satker.php' target='_blank'>";
	...
	print "TAHUN : <select name='thang' class='select-field'  >
									  ...
									  echo "</select>&nbsp;&nbsp;&nbsp;<input  type='submit' value='&nbsp;&nbsp;Cetak&nbsp;&nbsp;' />";		
