...
font-family: 'arial',  sans-serif;
 ...
 <center><br><span class='judulcontent'>CETAK LAPLAKGAR YANMASUM RUMKIT TINGKAT SATKER</span></center><br><br>
 
 <center>
 <?
  print "<div id='borderku' ><div class='form-style-2'>";
 print "<div class='codehim-tombol-biru'><form name='form1' method='GET'  action='cetak/cetak_mon_yanmasum_satker.php' target='_blank'>";
