...
font-family: Cambria, Palatino, "Palatino Linotype", "Palatino LT STD", Georgia, serif;
 ...
 <center><br><span class='judulcontent'>CETAK LAPLAKGAR BIDANG LOGISTIK TINGKAT SATKER </span></center><br><br>
 
 <center>
 <?php
  print "<div id='borderku' >";
 print "<div class='codehim-tombol-biru'><form name='form1' method='GET'  action='cetak/cetak_laplakgar_log_satker.php' target='_blank'>";
   print "<br><table width='100%' align='center' cellpadding='3' >";
  print "<input type='hidden' name='kdkotama'  value='$_SESSION[kdkotama]' />";	
 
  print "<input type='hidden' name='kdwasgiat'  value='04'  />";
