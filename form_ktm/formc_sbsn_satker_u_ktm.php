...
font-family: 'arial',  sans-serif;
 ...
 <center><br><span class='judulcontent'>CETAK LAPLAKGAR SBSN TINGKAT SATKER</span></center><br><br>
 ...
 print "<form name='form1' method='GET'  action='cetak/cetak_mon_sbsn_satker.php' target='_blank'>";
	...
	print "TAHUN : <select name='thang' class='select-field'  >
									  ...
									  echo "</select>&nbsp;&nbsp&nbsp<input  type='submit' value='Cetak' class='button blue'/>";		
