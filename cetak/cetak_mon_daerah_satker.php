...
$pdf->Cell(12,5,'Tanggal',0,0,'L',1);
	 ...
	 $sql= mysql_query("SELECT '' as id_pagu,  a.kdwasgiat, a.kdkotama, a.kdsatker, a.thang, '' as kode, '1' as display,  'RUPIAH MURNI' as uraian, sum(a.pagu) as pagu, sum(a.revisi) as revisi, sum(a.pagurevisi) as pagurevisi, c.blnlalu, d.blnini
FROM dipa a 
...
union (SELECT '' as id_pagu, a.kdwasgiat, a.kdkotama, a.kdsatker,  a.thang, a.kdjenbel as kode, concat('1',a.kdjenbel) as display, b.nmjenbel as uraian, sum(a.pagu) as pagu, sum(a.revisi) as revisi, sum(a.pagurevisi) as pagurevisi, c.blnlalu, d.blnini
FROM dipa a 
left join t_jenbel b on a.kdjenbel=b.kdjenbel
left join (select kdjenbel, kdkotama, kdsatker, thang, sum(realisasi) as blnlalu from realisasi where kdbulan<'$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' group by kdjenbel) as c on a.kdjenbel=c.kdjenbel
left join (select kdjenbel, kdkotama, kdsatker, thang, sum(realisasi) as  blnini from realisasi where kdbulan='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' group by kdjenbel) as d on a.kdjenbel=d.kdjenbel
where  a.kdkotama='$_GET[kdkotama]' and a.kdsatker='$_GET[kdsatker]' and a.thang='$_GET[thang]' 
group by a.kdjenbel)
union (SELECT '' as id_pagu, a.kdwasgiat, a.kdkotama, a.kdsatker, a.thang, concat(a.kdprogram,'.',a.kdgiat) as kode, concat('1',a.kdjenbel,a.kdgiat) as display, b.nmgiat as uraian, sum(a.pagu) as pagu, sum(a.revisi) as revisi, sum(a.pagurevisi) as pagurevisi, c.blnlalu, d.blnini
FROM dipa a 
left join t_giat b on a.kdgiat=b.kdgiat
left join (select kdjenbel, kdgiat, kdkotama, kdsatker, thang, sum(realisasi) as blnlalu from realisasi 
where kdbulan<'$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' group by kdjenbel,kdgiat) as c on a.kdjenbel=c.kdjenbel and  a.kdgiat=c.kdgiat
left join (select kdjenbel, kdgiat, kdkotama, kdsatker, thang, sum(realisasi)  as blnini from realisasi 
where kdbulan='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' group by kdjenbel,kdgiat) as d on a.kdjenbel=d.kdjenbel and  a.kdgiat=d.kdgiat
where  a.kdkotama='$_GET[kdkotama]' and a.kdsatker='$_GET[kdsatker]' and a.thang='$_GET[thang]' 
group by a.kdjenbel,a.kdgiat)
union (SELECT '' as id_pagu,  a.kdwasgiat, a.kdkotama, a.kdsatker, a.thang, concat(a.kdoutput,'.',a.kdakun) as kode, concat('1',a.kdjenbel,a.kdgiat,a.kdoutput,a.kdakun) as display, a.nmakun as uraian,  
...
where  a.kdkotama='$_GET[kdkotama]' and a.kdsatker='$_GET[kdsatker]' and a.thang='$_GET[thang]' 
group by  a.kdgiat,a.kdoutput,a.kdakun)
union (SELECT '' as id_pagu,  a.kdwasgiat, a.kdkotama, a.kdsatker, a.thang, a.kdakun as kode, concat('1',a.kdjenbel,a.kdgiat,a.kdoutput,a.kdakun, a.kdsakun) as display, a.nmsakun as uraian,  
sum(a.pagu) as pagu, sum(a.revisi) as revisi, sum(a.pagurevisi) as pagurevisi, c.blnlalu, d.blnini
FROM dipa a 
...
where  a.kdkotama='$_GET[kdkotama]' and a.kdsatker='$_GET[kdsatker]' and a.thang='$_GET[thang]' 
group by  a.kdgiat,a.kdoutput,a.kdakun,a.kdsakun)
union (SELECT a.id_pagu, a.kdwasgiat, a.kdkotama, a.kdsatker, a.thang, a.kdakun as kode, concat('1',a.kdjenbel,a.kdgiat,a.kdoutput,a.kdakun, a.kdsakun,a.urutitem) as display, concat('-',' ', a.nmitem) as uraian, sum(a.pagu) as pagu, sum(a.revisi) as revisi, sum(a.pagurevisi) as pagurevisi, c.blnlalu, d.blnini 
FROM dipa  a
left join (select id_pagu, sum(realisasi) as blnlalu from realisasi where kdbulan<'$_GET[kdbulan]'  and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' group by id_pagu) as c on a.id_pagu=c.id_pagu
...
// memberikan nomor urut berupa romawi, norut dan abjad	
	...
	if ($pj <'19' ) { // jika digit kurang dari 14 dicetak tebal (sampai kode output)
...
left join (select id_pagu,kdkotama, kdsatker,  thang, sum(realisasi) as blnini from 
realisasi  where kdbulan='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]'  and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' group by kdkotama, kdsatker, thang) as d on a.kdkotama=d.kdkotama and a.kdsatker=d.kdsatker and a.thang=d.thang 
where a.kdkotama='$_GET[kdkotama]' and a.kdsatker='$_GET[kdsatker]' and a.thang='$_GET[thang]' 
group by a.kdkotama,a.kdsatker,a.thang"); 
...
left join (select kdkotama, kdsatker, thang, kdjenbel, sum(pagu) as pagu, sum(revisi) as revisi, sum(pagurevisi) as pagurevisi  from dipa where kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' group by kdkotama,kdsatker,thang,kdjenbel) as b on a.kdjenbel=b.kdjenbel 
left join (select kdkotama, kdsatker, thang, sum(realisasi) as blnlalu, kdjenbel from realisasi where kdbulan<'$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' group by kdkotama, kdsatker, thang, kdjenbel) as c on a.kdjenbel=c.kdjenbel
left join (select kdkotama, kdsatker, thang, sum(realisasi) as blnini, kdjenbel from realisasi  where kdbulan='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' group by kdkotama, kdsatker, thang, kdjenbel) as d on a.kdjenbel=d.kdjenbel 
