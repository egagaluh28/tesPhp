...
left join (select kdprogram, sum(pagurevisi) as pagu51 from dipa where kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' and kdjenbel='51' group by kdprogram) as b on a.kdprogram=b.kdprogram
left join( select kdprogram, sum(realisasi) as real51 from realisasi where kdbulan<='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' and kdjenbel='51' group by kdprogram) as b1 on a.kdprogram=b1.kdprogram
left join (select kdprogram, sum(pagurevisi) as pagu52 from dipa where kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' and kdjenbel='52' group by kdprogram) as c on a.kdprogram=c.kdprogram
left join( select kdprogram, sum(realisasi) as real52 from  realisasi where kdbulan<='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' and kdjenbel='52' group by kdprogram) as c1 on a.kdprogram=c1.kdprogram
left join (select kdprogram, sum(pagurevisi) as pagu53 from dipa where kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' and kdjenbel='53' group by kdprogram) as d on a.kdprogram=d.kdprogram
left join(select kdprogram, sum(realisasi) as real53 from  realisasi  where kdbulan<='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' and kdjenbel='53' group by kdprogram) as d1 on a.kdprogram=d1.kdprogram
...
$pdf->Ln();
 ...
 $jml = mysql_query("select a.kdkotama, a.kdsatker, a.thang, b.pagu51, b1.real51, c.pagu52, c1.real52, d.pagu53, d1.real53 from dipa a
left join (select kdkotama, kdsatker, thang, sum(pagurevisi) as pagu51 from dipa  where kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' and kdjenbel='51' group by kdkotama, kdsatker, thang) as b on a.kdkotama=b.kdkotama and a.kdsatker=b.kdsatker and a.thang=b.thang
left join (select kdkotama, kdsatker, thang, sum(realisasi) as real51 from realisasi where kdbulan<='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' and kdjenbel='51' group by kdkotama, kdsatker, thang) as b1 on a.kdkotama=b1.kdkotama and a.kdsatker=b1.kdsatker and a.thang=b1.thang
left join (select kdkotama, kdsatker, thang, sum(pagurevisi) as pagu52 from dipa  where kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' and kdjenbel='52' group by kdkotama, kdsatker, thang) as c on a.kdkotama=c.kdkotama and a.kdsatker=c.kdsatker and a.thang=c.thang
left join (select kdkotama, kdsatker, thang, sum(realisasi) as real52 from realisasi where kdbulan<='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' and kdjenbel='52' group by kdkotama, kdsatker, thang) as c1 on a.kdkotama=c1.kdkotama and a.kdsatker=c1.kdsatker and a.thang=c1.thang
left join (select kdkotama, kdsatker, thang, sum(pagurevisi) as pagu53 from dipa  where kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' and kdjenbel='53' group by kdkotama, kdsatker, thang) as d on a.kdkotama=d.kdkotama and a.kdsatker=d.kdsatker and a.thang=d.thang
left join (select kdkotama, kdsatker, thang, sum(realisasi) as real53 from realisasi  where kdbulan<='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' and kdjenbel='53' group by kdkotama, kdsatker, thang) as d1 on a.kdkotama=d1.kdkotama and a.kdsatker=d1.kdsatker and a.thang=d1.thang
