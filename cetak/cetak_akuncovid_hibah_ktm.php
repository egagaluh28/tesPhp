...
left join (select  id_pagu, kdakun,  kdkotama, kdsatker, thang, sum(realisasi) as blnlalu from realisasi_hibah where kdbulan<'$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]'  and thang='$_GET[thang]' and kdakun='521131' group by kdsatker) as c on   a.kdsatker=c.kdsatker 
left join (select  id_pagu, kdakun,  kdkotama, kdsatker,  thang, sum(realisasi) as  blnini from realisasi_hibah where kdbulan='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]'  and thang='$_GET[thang]' and kdakun='521131' group by kdsatker) as d on   a.kdsatker=d.kdsatker 
...
sum(a.pagu) as pagu, sum(a.revisi) as revisi, sum(a.pagurevisi) as pagurevisi,    c.blnlalu, d.blnini FROM hibah a 
left join (select  id_pagu, kdakun,  kdkotama,  thang, sum(realisasi) as blnlalu from realisasi_hibah where kdbulan<'$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]'  and thang='$_GET[thang]' and kdakun='521131' group by id_pagu) as c on   a.id_pagu=c.id_pagu 
left join (select  id_pagu, kdakun,  kdkotama,  thang, sum(realisasi) as  blnini from realisasi_hibah where kdbulan='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]'  and thang='$_GET[thang]' and kdakun='521131' group by id_pagu) as d on   a.id_pagu=d.id_pagu 
...
$pdf->SetFont('arialnarrow','',11);
$pdf->Cell(0,5,'LAPORAN PELAKSANAAN ANGGARAN COVID-19 (HIBAH)',0,1,'C');
$pdf->SetY(43); 
...
left join (select  kdkotama,  thang, sum(realisasi) as blnlalu from realisasi_hibah where kdbulan<'$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]'  and thang='$_GET[thang]' and kdakun='521131' group by kdkotama) as c on   a.kdkotama=c.kdkotama 
left join (select kdkotama,  thang, sum(realisasi) as  blnini from realisasi_hibah where kdbulan='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]'  and thang='$_GET[thang]' and kdakun='521131' group by kdkotama) as d on   a.kdkotama=d.kdkotama 
