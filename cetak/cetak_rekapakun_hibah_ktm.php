...
FROM hibah a 
left join (select kdgiat, kdoutput, kdakun,  kdkotama, thang, sum(realisasi) as blnlalu from realisasi_hibah where kdbulan<'$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and thang='$_GET[thang]' group by  kdakun) as c on   a.kdakun=c.kdakun 
left join (select kdgiat, kdoutput, kdakun,  kdkotama, thang, sum(realisasi) as  blnini from realisasi_hibah where kdbulan='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and thang='$_GET[thang]' group by  kdakun) as d on   a.kdakun=d.kdakun 
