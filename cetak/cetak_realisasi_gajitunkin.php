...
$pdf->Cell($garis+5,0,'                             ','T',0,'C',1);
	 ...
	 $sql= mysql_query("SELECT 'Gaji dan Tunjangan' as uraian, a.thang, a.kdkotama, a.kdsatker, sum(a.pagurevisi) as pagurevisi, c.penarikan
FROM dipa a 
left join (select  kdkotama, kdsatker, thang, sum(realisasi) as penarikan from  realisasi  where kdbulan<='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' and kdakun in ('511161', '511169', '511171', '511172', '511173', '511174', '511175', '511176', '511179', '511185', 
...
$pdf->SetY(55); 
$pdf->SetX(25);
$pdf->Cell(50,12,'URAIAN',1,0,'C',1); 

$pdf->SetY(55); 
$pdf->SetX(75);
$pdf->Cell(37,6,'DIPA TA','LRT',0,'C',0); 
$pdf->SetY(61); 
$pdf->SetX(75);
$pdf->Cell(37,6,'SETELAH REVISI','LRB',0,'C',0); 

$pdf->SetY(55); 
$pdf->SetX(112);
$pdf->Cell(37,6,'REALISASI S.D','LRT',0,'C',0); 
$pdf->SetY(61); 
$pdf->SetX(112);
$pdf->Cell(37,6,$sasi.' '.$_GET[thang],'LRB',0,'C',0); 
/*
$pdf->SetY(55); 
$pdf->SetX(221);
...
$pdf->SetY(55); 
$pdf->SetX(149);
$pdf->Cell(37,6,'SISA','LRT',0,'C',0); 
$pdf->SetY(61); 
$pdf->SetX(149);
$pdf->Cell(37,6,'(3-4)','LRB',0,'C',0); 
...
$pdf->Cell(50,6,'2',1,0,'C',0); 
$pdf->Cell(37,6,'3',1,0,'C',0);
$pdf->Cell(37,6,'4',1,0,'C',0); 
$pdf->Cell(37,6,'5',1,0,'C',0);
...
// memberikan nomor urut berupa romawi, norut dan abjad	
		...
		$pdf->SetY($ng);
		$pdf->SetX(25);
		$pdf->Cell(50,6,$row[uraian],'LR',1,'L',2);
		
		$pdf->SetY($ng);
		$pdf->SetX(75);
		$pdf->Cell(37,6,$hasil,'LR',1,'R',2);
		
		$pdf->SetY($ng);
		$pdf->SetX(112);
		$pdf->Cell(37,6,$hasil1,'LR',1,'R',2); 
...
'511189', '511191', '511192', '511193', '511194', '511195', '511211', '511219', '511221', '511222',
'511223', '511224', '511225', '511226', '511227', '511228', '511232', '511233', '511234', '511235',
'511236', '511237', '511238', '511239', '511241', '511242', '511243', '511244', '511245','512211','512411') group by a.kdakun) as z where z.kdkotama='$_GET[kdkotama]' and z.kdsatker='$_GET[kdsatker]' and z.thang='$_GET[thang]'"); 
$x = mysql_fetch_array($jml);	
	...
	$pdf->Cell(50,6,'J U M L A H',1,0,'L',1); 
	$pdf->Cell(37,6,$hasilx,1,0,'R',1);
	$pdf->Cell(37,6,$hasil1x,1,0,'R',1);
	//$pdf->Cell(18,6,$prosen_desx,1,0,'C',1);
	$pdf->Cell(37,6,$sisax,1,0,'R',1);
