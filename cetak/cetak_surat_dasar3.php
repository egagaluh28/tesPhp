...
//-----------------------isi surat---------------------------------------------------------
 $kueri=mysql_query("select  a.*, b.nmbulan from surat a
					...
					where a.kdbulan='$_GET[kdbulan]' and a.thang='$_GET[thang]' and a.kdkotama='$_GET[kdkotama]' and a.kdsatker='$_GET[kdsatker]'");
 $row    = mysql_fetch_array($kueri);
 
 $pg=mysql_query("select sum(pagu) as pagu, sum(revisi) as revisi, sum(pagurevisi) as pagurevisi from dipa where thang='$_GET[thang]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' group by kdkotama,kdsatker,thang");
 $row1    = mysql_fetch_array($pg);
 
 $reals=mysql_query("select sum(realisasi) as realisasi from realisasi where thang='$_GET[thang]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and kdbulan<='$row[kdbulan]' group by kdkotama,kdsatker,thang");
...
$pagu51=mysql_query("select sum(pagurevisi) as pagurevisi from dipa where thang='$_GET[thang]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and kdjenbel='51' group by kdjenbel");
$x51    = mysql_fetch_array($pagu51);



$reals51=mysql_query("select sum(realisasi) as realisasi from realisasi where thang='$_GET[thang]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and kdjenbel='51' and kdbulan<='$row[kdbulan]' group by kdjenbel");
...
$pagu52=mysql_query("select sum(pagurevisi) as pagurevisi from dipa where thang='$_GET[thang]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and kdjenbel='52' group by kdjenbel");
$x52    = mysql_fetch_array($pagu52);

$reals52=mysql_query("select sum(realisasi) as realisasi from realisasi where thang='$_GET[thang]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and kdjenbel='52' and kdbulan<='$row[kdbulan]' group by kdjenbel");
...
$pagu53=mysql_query("select sum(pagurevisi) as pagurevisi from dipa where thang='$_GET[thang]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and kdjenbel='53' group by kdjenbel");
$x53    = mysql_fetch_array($pagu53);

$reals53=mysql_query("select sum(realisasi) as realisasi from realisasi where thang='$_GET[thang]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and kdjenbel='53' and kdbulan<='$row[kdbulan]' group by kdjenbel");
