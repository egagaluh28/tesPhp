...
$rowop= mysql_query("select * from kopstuk where kdkotama='$_GET[kdkotama]' and kdsatker='000000'"); 
...
from t_jns_pnbpum a   
left join (select kd_jns_pnbpum, sum(target_tarif) as target_tarif, sum(target_jumlah) as target_jumlah from pnbpum where kdkotama='$_GET[kdkotama]' and thang='$_GET[thang]' group by kd_jns_pnbpum) as b on a.kd_jns_pnbpum=b.kd_jns_pnbpum
left join (select kd_jns_pnbpum, sum(realisasi_tarif) as realisasi_tarif, sum(realisasi_jumlah) as realisasi_jumlah from realisasi_pnbpum where kdkotama='$_GET[kdkotama]' and thang='$_GET[thang]' and kdtw<='$_GET[kdtw]' group by kd_jns_pnbpum) as d on a.kd_jns_pnbpum=d.kd_jns_pnbpum
...
left join (select idpnbpum, kd_jns_pnbpum, kdakun, vol_target, sum(target_tarif) as target_tarif, sum(target_jumlah) as target_jumlah from pnbpum where kdkotama='$_GET[kdkotama]'  and thang='$_GET[thang]' group by kd_jns_pnbpum, kdakun) as b on a.kd_jns_pnbpum=b.kd_jns_pnbpum and a.kdakun=b.kdakun 
left join (select idpnbpum, kd_jns_pnbpum, kdakun, vol_realisasi, sum(realisasi_tarif) as realisasi_tarif, sum(realisasi_jumlah) as realisasi_jumlah from realisasi_pnbpum where kdkotama='$_GET[kdkotama]'  and thang='$_GET[thang]' and kdtw<='$_GET[kdtw]' group by kd_jns_pnbpum, kdakun) as d on a.kd_jns_pnbpum=d.kd_jns_pnbpum and a.kdakun=d.kdakun) 
order by display"); 
...
from pnbpum a   
where kdkotama='$_GET[kdkotama]'  and thang='$_GET[thang]' 
...
where kdkotama='$_GET[kdkotama]'  and thang='$_GET[thang]'  and kdtw<='$_GET[kdtw]'
group by kdkotama,  thang");
