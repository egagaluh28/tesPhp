...
where a.kdkotama='$_GET[kdkotama]' and a.kdsatker='$_GET[kdsatker]' and a.thang='$_GET[thang]' and a.kdwasgiat='$_GET[kdwasgiat]' group by a.kdkotama, a.kdsatker, a.thang, a.kdwasgiat

union
(select concat('012.','22.',a.kdprogram) as kode, concat(a.kdsa,a.kdprogram) as display, b.nmprogram as uraian,
sum(a.pagu) as pagu, sum(a.revisi) as revisi, sum(a.pagurevisi) as pagurevisi, c.blnlalu, d.blnini
from dipa a 
left join t_program b on a.kdprogram=b.kdprogram
left join (select kdsa, kdprogram, kdkotama, kdsatker, thang, sum(realisasi) as blnlalu from  realisasi where kdbulan<'$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' and kdwasgiat='$_GET[kdwasgiat]'  group by kdsa,kdprogram) as c on  a.kdsa=c.kdsa and a.kdprogram=c.kdprogram
left join (select kdsa, kdprogram, kdkotama, kdsatker, thang, sum(realisasi) as blnini from realisasi where kdbulan='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]'  and kdwasgiat='$_GET[kdwasgiat]' group by kdsa,kdprogram) as d on  a.kdsa=d.kdsa and a.kdprogram=d.kdprogram
where a.kdkotama='$_GET[kdkotama]' and a.kdsatker='$_GET[kdsatker]' and a.thang='$_GET[thang]' and a.kdwasgiat='$_GET[kdwasgiat]' group by a.kdsa,a.kdprogram)
union
(select a.kdgiat as kode, concat(a.kdsa,a.kdprogram,a.kdgiat) as display, b.nmgiat as uraian,
sum(a.pagu) as pagu, sum(a.revisi) as revisi, sum(a.pagurevisi) as pagurevisi, c.blnlalu, d.blnini
from dipa a 
left join t_giat b on a.kdgiat=b.kdgiat
left join (select kdsa,kdprogram, kdgiat, kdkotama, kdsatker, thang, sum(realisasi) as blnlalu from realisasi  where kdbulan<'$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' and kdwasgiat='$_GET[kdwasgiat]' group by kdsa,kdprogram,kdgiat) as c on  a.kdsa=c.kdsa and a.kdprogram=c.kdprogram and a.kdgiat=c.kdgiat
left join (select kdsa, kdprogram, kdgiat, kdkotama, kdsatker, thang, sum(realisasi) as blnini from realisasi  where kdbulan='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' and kdwasgiat='$_GET[kdwasgiat]' group by kdsa,kdprogram,kdgiat) as d on  a.kdsa=d.kdsa and a.kdprogram=d.kdprogram and a.kdgiat=d.kdgiat
where a.kdkotama='$_GET[kdkotama]' and a.kdsatker='$_GET[kdsatker]' and a.thang='$_GET[thang]'  and a.kdwasgiat='$_GET[kdwasgiat]' group by a.kdsa,a.kdprogram,a.kdgiat)
union
(select a.kdoutput as kode, concat(a.kdsa,a.kdprogram,a.kdgiat,a.kdoutput) as display, b.nmoutput as uraian,
sum(a.pagu) as pagu, sum(a.revisi) as revisi, sum(a.pagurevisi) as pagurevisi, c.blnlalu, d.blnini
from dipa a 
left join t_output b on a.kdgiat=b.kdgiat and a.kdoutput=b.kdoutput
left join (select kdsa, kdprogram, kdgiat, kdoutput, kdkotama, kdsatker, thang, sum(realisasi) as blnlalu from realisasi where kdbulan<'$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' and kdwasgiat='$_GET[kdwasgiat]'  group by kdsa,kdprogram,kdgiat,kdoutput) as c on  a.kdsa=c.kdsa and a.kdprogram=c.kdprogram and a.kdgiat=c.kdgiat and a.kdoutput=c.kdoutput 
left join (select kdsa, kdprogram, kdgiat, kdoutput, kdkotama, kdsatker, thang, sum(realisasi) as blnini from realisasi where kdbulan='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' and kdwasgiat='$_GET[kdwasgiat]'  group by kdsa,kdprogram,kdgiat,kdoutput) as d on  a.kdsa=d.kdsa and a.kdprogram=d.kdprogram and a.kdgiat=d.kdgiat and a.kdoutput=d.kdoutput  
where a.kdkotama='$_GET[kdkotama]' and a.kdsatker='$_GET[kdsatker]' and a.thang='$_GET[thang]'  and a.kdwasgiat='$_GET[kdwasgiat]' group by a.kdsa,a.kdprogram,a.kdgiat,a.kdoutput)
union
(select a.kdakun as kode, concat(a.kdsa,a.kdprogram,a.kdgiat,a.kdoutput,a.kdakun) as display, b.nmakun as uraian,
sum(a.pagu) as pagu, sum(a.revisi) as revisi, sum(a.pagurevisi) as pagurevisi, c.blnlalu, d.blnini
from dipa a 
left join t_akun b on a.kdakun=b.kdakun
left join (select kdsa, kdprogram, kdgiat, kdoutput, kdakun, kdkotama, kdsatker, thang, sum(realisasi) as blnlalu from realisasi  where kdbulan<'$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' and kdwasgiat='$_GET[kdwasgiat]'  group by kdsa,kdprogram,kdgiat,kdoutput,kdakun) as c on  a.kdsa=c.kdsa and a.kdprogram=c.kdprogram and a.kdgiat=c.kdgiat and a.kdoutput=c.kdoutput and a.kdakun=c.kdakun 
left join (select kdsa, kdprogram, kdgiat, kdoutput, kdakun, kdkotama, kdsatker, thang, sum(realisasi) as blnini from  realisasi  where kdbulan='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' and kdwasgiat='$_GET[kdwasgiat]'  group by kdsa,kdprogram,kdgiat,kdoutput,kdakun) as d on  a.kdsa=d.kdsa and a.kdprogram=d.kdprogram and a.kdgiat=d.kdgiat and a.kdoutput=d.kdoutput and a.kdakun=d.kdakun 
where a.kdkotama='$_GET[kdkotama]' and a.kdsatker='$_GET[kdsatker]' and a.thang='$_GET[thang]'  and a.kdwasgiat='$_GET[kdwasgiat]' group by a.kdsa,a.kdprogram,a.kdgiat,a.kdoutput,a.kdakun)
union
(select a.kdakun as kode, concat(a.kdsa,a.kdprogram,a.kdgiat,a.kdoutput,a.kdakun,a.kdsakun) as display, concat('> ',a.nmsakun) as uraian,
sum(a.pagu) as pagu, sum(a.revisi) as revisi, sum(a.pagurevisi) as pagurevisi, c.blnlalu, d.blnini
from dipa a 
left join (select kdsa, kdprogram, kdgiat, kdoutput, kdakun, kdsakun, kdkotama, kdsatker, thang, sum(realisasi) as blnlalu from realisasi  where kdbulan<'$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]'  and kdwasgiat='$_GET[kdwasgiat]' 
group by kdsa,kdprogram,kdgiat, kdoutput, kdakun,kdsakun) as c on  a.kdsa=c.kdsa and a.kdprogram=c.kdprogram and a.kdgiat=c.kdgiat and a.kdoutput=c.kdoutput and a.kdakun=c.kdakun and a.kdsakun=c.kdsakun
left join (select kdsa, kdprogram, kdgiat, kdoutput, kdakun, kdsakun, kdkotama, kdsatker, thang, sum(realisasi) as blnini from realisasi  where kdbulan='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' and kdwasgiat='$_GET[kdwasgiat]'  group by kdsa,kdprogram,kdgiat, kdoutput, kdakun,kdsakun) as d on  a.kdsa=d.kdsa and a.kdprogram=d.kdprogram and a.kdgiat=d.kdgiat and a.kdoutput=d.kdoutput and a.kdakun=d.kdakun and a.kdsakun=d.kdsakun
where a.kdkotama='$_GET[kdkotama]' and a.kdsatker='$_GET[kdsatker]' and a.thang='$_GET[thang]'  and a.kdwasgiat='$_GET[kdwasgiat]' group by a.kdsa,a.kdprogram,a.kdgiat,a.kdoutput,a.kdakun, a.kdsakun)
union
(select '' as kode, concat(a.kdsa,a.kdprogram,a.kdgiat,a.kdoutput,a.kdakun,a.kdsakun,a.urutitem) as display, 
concat('- ',a.nmitem) as uraian,
a.pagu, a.revisi, a.pagurevisi, c.blnlalu, d.blnini
from dipa a 
left join (select id_pagu, kdsa, kdprogram, kdgiat, kdoutput, kdakun, kdsakun, kdkotama, kdsatker, thang, sum(realisasi) as blnlalu from realisasi b  where kdbulan<'$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' and kdwasgiat='$_GET[kdwasgiat]' group by id_pagu) as c on  a.id_pagu=c.id_pagu
left join (select id_pagu, kdsa, kdprogram, kdgiat, kdoutput, kdakun, kdsakun, kdkotama, kdsatker, thang, sum(realisasi) as blnini from realisasi where kdbulan='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' and kdwasgiat='$_GET[kdwasgiat]'  group by id_pagu) as d on  a.id_pagu=d.id_pagu
where a.kdkotama='$_GET[kdkotama]' and a.kdsatker='$_GET[kdsatker]' and a.thang='$_GET[thang]' and a.kdwasgiat='$_GET[kdwasgiat]'  group by a.id_pagu order by a.noitem) order by display"); 
...
$pdf->SetFont('arialnarrow','',11);
$pdf->Cell(0,5,'PELAKSANAAN ANGGARAN DIPA PETIKAN SATKER DAERAH BIDANG'.' '.$bidang,0,1,'C');
$pdf->SetY(43); 
...
from dipa a 
left join (select id_pagu,kdkotama, kdsatker,  thang, kdwasgiat, sum(realisasi) as blnlalu from realisasi where kdbulan<'$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]'  and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]'  and kdwasgiat='$_GET[kdwasgiat]' group by kdkotama, kdsatker, thang, kdwasgiat) as c on a.kdkotama=c.kdkotama and a.kdsatker=c.kdsatker and a.thang=c.thang and a.kdwasgiat=c.kdwasgiat
left join (select id_pagu,kdkotama, kdsatker,  thang, kdwasgiat, sum(realisasi) as blnini  from realisasi where kdbulan='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]'  and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]'  and kdwasgiat='$_GET[kdwasgiat]'  group by kdkotama, kdsatker, thang, kdwasgiat) as d on a.kdkotama=d.kdkotama and a.kdsatker=d.kdsatker and a.thang=d.thang and a.kdwasgiat=d.kdwasgiat
where a.kdkotama='$_GET[kdkotama]' and a.kdsatker='$_GET[kdsatker]' and a.thang='$_GET[thang]'  and a.kdwasgiat='$_GET[kdwasgiat]' group by a.kdkotama,a.kdsatker,a.thang, a.kdwasgiat"); 
...
left join (select kdkotama, kdsatker, thang, kdjenbel, sum(pagu) as pagu, sum(revisi) as revisi, sum(pagurevisi) as pagurevisi  from dipa where kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' 
and kdwasgiat='$_GET[kdwasgiat]' group by kdjenbel) as b on a.kdjenbel=b.kdjenbel 
left join (select kdkotama, kdsatker, thang, sum(realisasi) as blnlalu, kdjenbel from realisasi where kdbulan<'$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' and kdwasgiat='$_GET[kdwasgiat]' group by kdjenbel) as c on a.kdjenbel=c.kdjenbel 
left join (select kdkotama, kdsatker, thang, sum(realisasi) as blnini,  kdjenbel from realisasi where kdbulan='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' and kdwasgiat='$_GET[kdwasgiat]' group by kdjenbel) as d on a.kdjenbel=d.kdjenbel 
