...
$pdf->Cell($garis+9,0,'                             ','T',0,'C',1);
	 ...
	 $sql= mysql_query("select a.kdsatkr as display, a.kdsatkr as kdsatker, '' as kdakun, a.nmsatkr as nmakun, b.jandes, b.gaji13, b.gaji14 from t_satkr a 
...
*/
		...
		if ($pj=='6') {	
	    $pdf->SetFont('Arial','B',10.7);
		$pdf->Cell(10,6,$abjad.''.'.','LR',1,'C',1);
	...
	$no++;
	  ...
	  $qry = mysql_query("select sum(jandes) as jandes, sum(gaji13) as gaji13, sum(gaji14) as gaji14 from renbut where kdkotama='$_GET[kdkotama]' and thang='$_GET[thang]' group by kdkotama");
