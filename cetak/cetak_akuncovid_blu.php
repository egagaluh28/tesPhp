...
left join (select  id_pagu, kdakun,  kdkotama, kdsatker, thang, sum(realisasi) as blnlalu from realisasi_blu where kdbulan<'$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' and kdakun in ('525155','537122','537125','525152','525153','525154') group by id_pagu) as c on   a.id_pagu=c.id_pagu 

left join (select  id_pagu, kdakun,  kdkotama, kdsatker, thang, sum(realisasi) as  blnini from realisasi_blu where kdbulan='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and kdsatker='$_GET[kdsatker]' and thang='$_GET[thang]' and kdakun in ('525155','537122','537125','525152','525153','525154') group by id_pagu) as d on   a.id_pagu=d.id_pagu 

where  a.kdkotama='$_GET[kdkotama]' and a.kdsatker='$_GET[kdsatker]' and a.thang='$_GET[thang]' and a.kdakun in ('525155','537122','537125','525152','525153','525154')  group by a.id_pagu order by a.id_pagu"); 
...
and kdakun in ('525155','537122','537125','525152','525153','525154') group by a.kdkotama,a.kdsatker,a.thang"); 
