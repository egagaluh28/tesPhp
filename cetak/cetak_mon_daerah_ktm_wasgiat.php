...
left join (select a.kdjenbel, a.kdkotama, a.kdwasgiat, a.thang, sum(b.realisasi) as blnlalu from dipa a left join realisasix b on a.id_pagu=b.id_pagu where b.kdbulan<'$_GET[kdbulan]' and a.kdkotama='$_GET[kdkotama]' and a.thang='$_GET[thang]' and a.kdwasgiat='$_GET[kdwasgiat]' group by a.kdjenbel) as c on  a.kdjenbel=c.kdjenbel
left join (select a.kdjenbel, a.kdkotama,  a.thang, sum(b.realisasi) as blnini from dipa a left join realisasix b on a.id_pagu=b.id_pagu where b.kdbulan='$_GET[kdbulan]' and a.kdkotama='$_GET[kdkotama]' and a.thang='$_GET[thang]' and a.kdwasgiat='$_GET[kdwasgiat]' group by a.kdjenbel) as d on  a.kdjenbel=d.kdjenbel
where  a.kdkotama='$_GET[kdkotama]' and a.thang='$_GET[thang]' and a.kdwasgiat='$_GET[kdwasgiat]'  
group by a.kdjenbel)
...
and a.thang='$_GET[thang]' and a.kdwasgiat='$_GET[kdwasgiat]' group by a.kdgiat,a.kdoutput, a.kdakun) as d on  a.kdgiat=d.kdgiat and a.kdoutput=d.kdoutput and a.kdakun=d.kdakun 
where  a.kdkotama='$_GET[kdkotama]' and a.thang='$_GET[thang]'  and a.kdwasgiat='$_GET[kdwasgiat]' group by  a.kdgiat,a.kdoutput,a.kdakun)
...
where  a.kdkotama='$_GET[kdkotama]' and a.thang='$_GET[thang]' and a.kdwasgiat='$_GET[kdwasgiat]' group by a.kdgiat,a.kdoutput,a.kdakun,a.kdsakun) 
order by display"); 
...
a.thang='$_GET[thang]' and  a.kdwasgiat='$_GET[kdwasgiat]' group by a.kdkotama, a.thang, a.kdwasgiat) as c on a.kdkotama=c.kdkotama and a.thang=c.thang 

left join (select a.id_pagu,a.kdkotama,  a.thang, sum(b.realisasi) as blnini from dipa a
left join realisasix b on a.id_pagu=b.id_pagu where b.kdbulan='$_GET[kdbulan]' and a.kdkotama='$_GET[kdkotama]'  and  
a.thang='$_GET[thang]' and a.kdwasgiat='$_GET[kdwasgiat]' group by a.kdkotama, a.thang, a.kdwasgiat) as d on a.kdkotama=d.kdkotama and a.thang=d.thang 
...
left join (select kdwasgiat, kdkotama, thang, kdjenbel, sum(pagu) as pagu, sum(revisi) as revisi, sum(pagurevisi) as pagurevisi  from dipa where kdkotama='$_GET[kdkotama]'  and thang='$_GET[thang]' and kdwasgiat='$_GET[kdwasgiat]' group by kdkotama,thang,kdjenbel,kdwasgiat) as b on a.kdjenbel=b.kdjenbel 

left join (select a.kdkotama,  a.thang, sum(a.realisasi) as blnlalu, b.kdwasgiat, b.kdjenbel from realisasix a left join dipa b on a.id_pagu=b.id_pagu where a.kdbulan<'$_GET[kdbulan]' and a.kdkotama='$_GET[kdkotama]' and a.thang='$_GET[thang]' and 
b.kdwasgiat='$_GET[kdwasgiat]' group by a.kdkotama, a.thang, b.kdjenbel, b.kdwasgiat) as c on b.kdkotama=c.kdkotama and b.thang=c.thang and b.kdjenbel=c.kdjenbel 

left join (select a.kdkotama,  a.thang, sum(a.realisasi) as blnini, b.kdwasgiat, b.kdjenbel from realisasix a left join dipa b on a.id_pagu=b.id_pagu where a.kdbulan='$_GET[kdbulan]' and a.kdkotama='$_GET[kdkotama]' and a.thang='$_GET[thang]' and 
b.kdwasgiat='$_GET[kdwasgiat]' group by a.kdkotama, a.thang, b.kdjenbel, b.kdwasgiat) as d on b.kdkotama=d.kdkotama and b.thang=d.thang and b.kdjenbel=d.kdjenbel 
