...
from t_jns_pnbpum a   
left join (select kd_jns_pnbpum, sum(target_tarif) as target_tarif, sum(target_jumlah) as target_jumlah from pnbpum where thang='$_GET[thang]' group by kd_jns_pnbpum) as b on a.kd_jns_pnbpum=b.kd_jns_pnbpum
left join (select kd_jns_pnbpum, sum(realisasi_tarif) as realisasi_tarif, sum(realisasi_jumlah) as realisasi_jumlah from realisasi_pnbpum where thang='$_GET[thang]' and kdtw<='$_GET[kdtw]' group by kd_jns_pnbpum) as d on a.kd_jns_pnbpum=d.kd_jns_pnbpum
...
left join (select idpnbpum, kd_jns_pnbpum, kdakun, vol_target, sum(target_tarif) as target_tarif, sum(target_jumlah) as target_jumlah from pnbpum where  thang='$_GET[thang]' group by kd_jns_pnbpum, kdakun) as b on a.kd_jns_pnbpum=b.kd_jns_pnbpum and a.kdakun=b.kdakun 
left join (select idpnbpum, kd_jns_pnbpum, kdakun, vol_realisasi, sum(realisasi_tarif) as realisasi_tarif, sum(realisasi_jumlah) as realisasi_jumlah from realisasi_pnbpum where thang='$_GET[thang]' and kdtw<='$_GET[kdtw]' group by kd_jns_pnbpum, kdakun) as d on a.kd_jns_pnbpum=d.kd_jns_pnbpum and a.kdakun=d.kdakun) 
order by display"); 
...
//spasi
 ...
 $jml = mysql_query("select thang, sum(target_tarif) as target_tarif, sum(target_jumlah) as target_jumlah from pnbpum a   
where  thang='$_GET[thang]' group by   thang");
   ...
   $jml_reals = mysql_query("select thang, sum(realisasi_tarif) as realisasi_tarif, sum(realisasi_jumlah) as realisasi_jumlah from realisasi_pnbpum a   where thang='$_GET[thang]'  and kdtw<='$_GET[kdtw]' group by  thang");
