...
$pdf->Cell(7,12,'KET',1,0,'C',1); 
   ...
   $pdf->Ln();
	...
	$jprosenx 	= (($jhasil1x/$jhasilx)*100); $jprosen	 = number_format($jprosenx,0,',','.');
	...
	$pdf->Cell(7,5,$no,'LR',1,'C',2);
		...
		$pdf->Cell(15,5,$row[kdakun],'LR',1,'C',0);
		$pdf->SetY($ng);
		$pdf->SetX(110);
...
//spasi
	...
	$pdf->Cell(30,6,$jpagu,1,0,'R',1); 
	$pdf->Cell(28,6,$jrevisi,1,0,'R',1);
	$pdf->Cell(30,6,$jhasil,1,0,'R',1);
	$pdf->Cell(30,6,$jblnlalu,1,0,'R',1);
	$pdf->Cell(28,6,$jblnini,1,0,'R',1);
	$pdf->Cell(30,6,$jhasil1,1,0,'R',1);
