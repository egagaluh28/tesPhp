...
$pdf->Cell(12,5,'Tanggal',0,0,'L',1);
	 ...
	 $sql= mysql_query("SELECT '' as id_pagu,  a.kdwasgiat, a.kdkotama,  a.thang, '' as kode, '1' as display,  'SBSN' as uraian, sum(a.pagu) as pagu, sum(a.revisi) as revisi, sum(a.pagurevisi) as pagurevisi, c.blnlalu, d.blnini
FROM sbsn a 
left join(select kdkotama,  thang, sum(realisasi) as blnlalu from realisasi_sbsn where kdbulan<'$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and thang='$_GET[thang]' group by kdkotama,thang) as c on a.kdkotama=c.kdkotama  and a.thang=c.thang 
left join(select kdkotama,  thang, sum(realisasi) as blnini from realisasi_sbsn  where kdbulan='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and thang='$_GET[thang]' group by kdkotama,thang) as d on a.kdkotama=d.kdkotama and a.thang=d.thang 
...
left join (select kdprogram, kdkotama,  thang, sum(realisasi) as blnlalu from realisasi_sbsn where kdbulan<'$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and thang='$_GET[thang]' group by kdprogram) as c on  a.kdprogram=c.kdprogram
left join (select kdprogram, kdkotama,  thang, sum(realisasi) as blnini from realisasi_sbsn  where kdbulan='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and thang='$_GET[thang]' group by kdprogram) as d on  a.kdprogram=d.kdprogram
where  a.kdkotama='$_GET[kdkotama]' and a.thang='$_GET[thang]' 
...
left join (select kdprogram, kdgiat, kdkotama,  thang, sum(realisasi) as blnlalu from realisasi_sbsn  where kdbulan<'$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and thang='$_GET[thang]' group by kdprogram,kdgiat) as c on  a.kdprogram=c.kdprogram and  a.kdgiat=c.kdgiat
left join (select kdprogram, kdgiat, kdkotama,  thang, sum(realisasi) as blnini from  realisasi_sbsn where kdbulan='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and thang='$_GET[thang]' group by kdprogram,kdgiat) as d on  a.kdprogram=d.kdprogram and  a.kdgiat=d.kdgiat
where  a.kdkotama='$_GET[kdkotama]' and a.thang='$_GET[thang]' 
...
left join (select kdprogram, kdgiat, kdoutput, kdkotama,  thang, sum(realisasi) as blnlalu from realisasi_sbsn  where kdbulan<'$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and thang='$_GET[thang]' group by kdprogram,kdgiat,kdoutput) as c on  a.kdprogram=c.kdprogram and  a.kdgiat=c.kdgiat  and a.kdoutput=c.kdoutput
left join (select kdprogram, kdgiat,  kdoutput, kdkotama,  thang, sum(realisasi) as blnini from  realisasi_sbsn where kdbulan='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and thang='$_GET[thang]' group by kdprogram,kdgiat,kdoutput) as d on  a.kdprogram=d.kdprogram and  a.kdgiat=d.kdgiat and a.kdoutput=d.kdoutput
where  a.kdkotama='$_GET[kdkotama]' and a.thang='$_GET[thang]' 
...
FROM sbsn a 
left join (select kdgiat, kdoutput, kdakun,  kdkotama, thang, sum(realisasi) as blnlalu from realisasi_sbsn where kdbulan<'$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and thang='$_GET[thang]' group by kdgiat,kdoutput, kdakun) as c on  a.kdgiat=c.kdgiat and a.kdoutput=c.kdoutput and a.kdakun=c.kdakun 
left join (select kdgiat, kdoutput, kdakun,  kdkotama,  thang, sum(realisasi) as blnini from realisasi_sbsn where kdbulan='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]'  
...
from sbsn a 
left join (select id_pagu,kdkotama, thang, sum(realisasi) as blnlalu from realisasi_sbsn  where kdbulan<'$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and thang='$_GET[thang]' group by kdkotama, thang) as c on a.kdkotama=c.kdkotama and a.thang=c.thang 
left join (select id_pagu,kdkotama, thang, sum(realisasi) as blnini from realisasi_sbsn   where kdbulan='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]' and  thang='$_GET[thang]' group by kdkotama, thang) as d on a.kdkotama=d.kdkotama and a.thang=d.thang 
...
left join (select kdjenbel, kdkotama, thang, sum(realisasi) as blnlalu  from realisasi_sbsn where kdbulan<'$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]'  and thang='$_GET[thang]' group by  kdjenbel) as c on a.kdjenbel=c.kdjenbel 
left join (select  kdjenbel, kdkotama, thang, sum(realisasi) as blnini from realisasi_sbsn where kdbulan='$_GET[kdbulan]' and kdkotama='$_GET[kdkotama]'  and thang='$_GET[thang]' group by kdjenbel) as d on a.kdjenbel=d.kdjenbel 
