...
$pdf->Sety(18); 
$pdf->SetX($posisi-5); 
$pdf->Cell(40,5,'Lampiran'.' '.$_GET['lamp'],0,0,'L',0);
$pdf->Sety(23); 
$pdf->SetX($posisi-5); 
$pdf->Cell(40,5,'Nomor ',0,0,'L',0);
$pdf->Sety(28); 
$pdf->SetX($posisi-5); 
...
$pdf->Sety(18); 
$pdf->SetX(246); 
$pdf->Cell(40,5,$z[brs1],0,0,'R',0);

$pdf->Sety(23); 
$pdf->SetX(246); 
$pdf->Cell(40,5,$z[brs2],0,0,'R',0);
$pdf->Sety(28); 
$pdf->SetX(246); 
$pdf->Cell(40,5,$z[brs3],0,0,'R',0);
$pdf->Sety(33); 

$pdf->Sety(33); 
$pdf->SetX($posisi-4);
$pdf->Cell($garis+5,0,'                             ','T',0,'C',0);


   
	 $sql= mysql_query("select x.kdakun, x.nmakun, z.thang, z.kdkotama,   z.pagurevisi, z.penarikan
from t_akun_gaji x
...
$pdf->SetY(55); 
$pdf->SetX(145);
$pdf->Cell(38,12,'DIPA TA 2020',1,0,'C',1); 
