...
sum(a.pagu) as pagu, sum(a.revisi) as revisi, sum(a.pagurevisi) as pagurevisi,    c.blnlalu, d.blnini FROM blu a 

left join (select  id_pagu, kdakun,  kdkotama,  thang, sum(realisasi) as blnlalu from realisasi where kdbulan='$_GET[kdbulan]' and kdkotama='$_SESSION[kdkotama]'  and thang='$_GET[thang]' and kdakun in ('525155','537122','537125','525152','525153','525154') group by id_pagu) as c on   a.id_pagu=c.id_pagu 

left join (select  id_pagu, kdakun,  kdkotama,  thang, sum(realisasi) as  blnini from realisasi where kdbulan='$_GET[kdbulan]' and kdkotama='$_SESSION[kdkotama]'  and thang='$_GET[thang]' and kdakun in ('525155','537122','537125','525152','525153','525154') group by id_pagu) as d on   a.id_pagu=d.id_pagu 

where  a.kdkotama='$_SESSION[kdkotama]' and a.thang='$_GET[thang]' and a.kdakun in ('525155','537122')  group by a.id_pagu) as z 
...
left join (select  id_pagu, kdakun,  kdkotama, kdsatker, thang, sum(realisasi) as blnlalu from realisasi_blu where kdbulan<'$_GET[kdbulan]' and kdkotama='$_SESSION[kdkotama]'  and thang='$_GET[thang]' and kdakun in ('525155','537122','537125','525152','525153','525154') group by kdsatker) as c on   a.kdsatker=c.kdsatker 
left join (select  id_pagu, kdakun,  kdkotama, kdsatker,  thang, sum(realisasi) as  blnini from realisasi_blu where kdbulan='$_GET[kdbulan]' and kdkotama='$_SESSION[kdkotama]'  and thang='$_GET[thang]' and kdakun in ('525155','537122','537125','525152','525153','525154') group by kdsatker) as d on   a.kdsatker=d.kdsatker 
where  a.kdkotama='$_SESSION[kdkotama]' and a.thang='$_GET[thang]' and a.kdakun in ('525155','537122')  group by a.kdsatker

union
SELECT  concat(a.kdsatker,a.id_pagu) as display,  a.kdkotama, a.kdsatker, a.thang, a.kdakun, a.nmakun, a.nmitem, 
sum(a.pagu) as pagu, sum(a.revisi) as revisi, sum(a.pagurevisi) as pagurevisi,    c.blnlalu, d.blnini FROM blu a 
left join (select  id_pagu, kdakun,  kdkotama,  thang, sum(realisasi) as blnlalu from realisasi_blu where kdbulan<'$_GET[kdbulan]' and kdkotama='$_SESSION[kdkotama]'  and thang='$_GET[thang]' and kdakun in ('525155','537122','537125','525152','525153','525154') group by id_pagu) as c on   a.id_pagu=c.id_pagu 
left join (select  id_pagu, kdakun,  kdkotama,  thang, sum(realisasi) as  blnini from realisasi_blu where kdbulan='$_GET[kdbulan]' and kdkotama='$_SESSION[kdkotama]'  and thang='$_GET[thang]' and kdakun in ('525155','537122','537125','525152','525153','525154') group by id_pagu) as d on   a.id_pagu=d.id_pagu 
where  a.kdkotama='$_SESSION[kdkotama]' and a.thang='$_GET[thang]' and a.kdakun in ('525155','537122')  group by a.id_pagu
order by display");
...
<table  width='98%' align='center'>
    <tr>
		 ...
		 <form name='form1' method='GET'  action='realisasiblu/kirimparameter_akuncovid_blu_ktm.php' >
	...
	print "&nbsp;&nbsp;<a href='cetak/cetak_akuncovid_blu_ktm.php?kdbulan=$_GET[kdbulan]&thang=$_GET[thang]&kdkotama=$_SESSION[kdkotama]&kdsatker=$_SESSION[kdsatker]' target='_blank' style='text-decoration:none'><input  type='button' value='Cetak' class='button2'/></a>";
	?> 
 ...
 ?>             
				...
				<?php	} ?>
                    ...
                    <?php
					 ...
					 $jml=mysql_query("SELECT  a.kdkotama, sum(a.pagu) as pagu, sum(a.revisi) as revisi, sum(a.pagurevisi) as pagurevisi,    c.blnlalu, d.blnini FROM blu a 

left join (select  kdkotama,  thang, sum(realisasi) as blnlalu from realisasi_blu where kdbulan<'$_GET[kdbulan]' and kdkotama='$_SESSION[kdkotama]'  and thang='$_GET[thang]' and kdakun in ('525155','537122') group by kdkotama) as c on   a.kdkotama=c.kdkotama 
left join (select kdkotama,  thang, sum(realisasi) as  blnini from realisasi_blu where kdbulan='$_GET[kdbulan]' and kdkotama='$_SESSION[kdkotama]'  and thang='$_GET[thang]' and kdakun in ('525155','537122') group by kdkotama) as d on   a.kdkotama=d.kdkotama 
where  a.kdkotama='$_SESSION[kdkotama]' and a.thang='$_GET[thang]' and a.kdakun in ('525155','537122')  group by a.kdkotama"); 
