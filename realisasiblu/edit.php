...
<? 
	     ...
	     $qry = mysql_query("select * from realisasi_blu where id_realisasi='$_GET[id_realisasi]' and id_pagu='$_GET[id_pagu]' ");
...
<form name="form1"  method="POST"  action="realisasiblu/proses.php?aksi=ubah">
  <table align="center" width="100%"   cellpadding="3" >
	...
	<?
	     $qryy = mysql_query("select id_pagu,  pagurevisi, nmitem from blu where id_pagu='$_GET[id_pagu]'");
