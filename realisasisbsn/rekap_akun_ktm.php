...
<html>
	...
	<br><center><span class='judulcontent'>REKAP PER AKUN (SBSN)</span></center><br>
...
//        pakai ini
            ...
            $reload = "media.php?module=rekap_akun_sbsn_ktm&thang=$_GET[thang]&kdbulan=$_GET[kdbulan]&pagination=true&keyword=$keyword";
...
FROM sbsn a 
left join (select kdgiat, kdoutput, kdakun,  kdkotama, thang, sum(realisasi) as blnlalu from realisasi_sbsn where kdbulan<'$_GET[kdbulan]' and kdkotama='$_SESSION[kdkotama]' and thang='$_GET[thang]' group by  kdakun) as c on   a.kdakun=c.kdakun 
left join (select kdgiat, kdoutput, kdakun,  kdkotama, thang, sum(realisasi) as  blnini from realisasi_sbsn where kdbulan='$_GET[kdbulan]' and kdkotama='$_SESSION[kdkotama]' and thang='$_GET[thang]' group by  kdakun) as d on   a.kdakun=d.kdakun 
...
//            jika tidak ada pencarian pakai ini
            $reload = "media.php?module=rekap_akun_sbsn_ktm&thang=$_GET[thang]&kdbulan=$_GET[kdbulan]&pagination=true";
...
<table  width='98%' align='center'>
    <tr>
		 ...
		 <form name='form1' method='GET'  action='realisasisbsn/kirimparameter_rekapakun_ktm.php' >
	...
	print "&nbsp;&nbsp;<a href='cetak/cetak_rekapakun_sbsn_ktm.php?kdbulan=$_GET[kdbulan]&thang=$_GET[thang]&kdkotama=$_SESSION[kdkotama]&kdsatker=$_SESSION[kdsatker]' target='_blank' style='text-decoration:none'><input  type='button' value='Cetak' class='button2'/></a>";
	?> 
		...
		<td align="right">
			...
			<a href="<?php print "media.php?module=rekap_akun_sbsn_ktm&thang=$_GET[thang]&kdbulan=$_GET[kdbulan]"; ?>"
