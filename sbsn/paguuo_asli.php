...
$query= "SELECT '' as id_pagu,  kdwasgiat,   thang, '' as kode, '1' as display,  'KAPITASI' as uraian, sum(pagu) as pagu, sum(revisi) as revisi, sum(pagurevisi) as pagurevisi
FROM kapitasi where thang='$_GET[thang]' group by  thang
...
FROM kapitasi a left join t_giat b on a.kdgiat=b.kdgiat where  a.thang='$_GET[thang]' 
...
FROM kapitasi a left join t_output b on a.kdgiat=b.kdgiat and a.kdoutput=b.kdoutput
...
FROM kapitasi where  thang='$_GET[thang]' 
