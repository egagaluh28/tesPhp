...
?>
   ...
   <form  name="form1" method="POST"  action="sbsn/proses.php?aksi=simpan" >
			...
			<tr><td><div class="suggestionsBox" id="suggestions" style="display: none;"> <img src="kapitasi/arrow.png" style="position: relative; top: -10px; left: 30px;" alt="upArrow" />
...
function suggest(inputString){
	...
	$('#kodespa').addClass('load');
		$.post("sbsn/proses_cari_autosuggest.php", {queryString: ""+inputString+""}, function(data){
			if(data.length >0) {
				$('#suggestions').fadeIn();
