...
print "<br><table  width='1100' align='center' ><tr><td class='judulcontent' align='center'>REKAP PAGU - BPJS $_GET[thang]</td></tr></table><br>";	

$query= "SELECT '' as id_pagu,  kdwasgiat,   thang, '' as kode, '1' as display,  'BPJS' as uraian, sum(pagu) as pagu, sum(revisi) as revisi, sum(pagurevisi) as pagurevisi
FROM bpjs where thang='$_GET[thang]' group by  thang
...
FROM bpjs a left join t_giat b on a.kdgiat=b.kdgiat where  a.thang='$_GET[thang]' 
...
FROM bpjs a left join t_output b on a.kdgiat=b.kdgiat and a.kdoutput=b.kdoutput
...
FROM bpjs where  thang='$_GET[thang]' 
