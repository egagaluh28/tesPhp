...
from dipa a
left join (select kdkotama, kdsatker, thang, sum(realisasi) as realisasi  from realisasi where kdkotama='$_SESSION[kdkotama]' and kdsatker='$_SESSION[kdsatker]' and thang='2024' group by kdkotama, kdsatker, thang) as b on a.kdkotama=b.kdkotama and a.kdsatker=b.kdsatker and a.thang=b.thang
where  a.kdkotama='$_SESSION[kdkotama]' and a.kdsatker='$_SESSION[kdsatker]' and a.thang='2024'
...
from yanmasum a
left join (select kdkotama, kdsatker, thang, sum(realisasi) as realisasi  from realisasi_yanmasum  where kdbulan<='12' and kdkotama='$_SESSION[kdkotama]' and kdsatker='$_SESSION[kdsatker]' and thang='2024' group by kdkotama, kdsatker, thang) as b on a.kdkotama=b.kdkotama and a.kdsatker=b.kdsatker and a.thang=b.thang
where  a.kdkotama='$_SESSION[kdkotama]' and a.kdsatker='$_SESSION[kdsatker]' and a.thang='2024'
group by a.kdkotama, a.kdsatker, a.thang"); 
...
from bpjs a
left join (select kdkotama, kdsatker, thang, sum(realisasi) as realisasi  from realisasi_bpjs  where kdbulan<='12' and kdkotama='$_SESSION[kdkotama]' and kdsatker='$_SESSION[kdsatker]' and thang='2024' group by kdkotama, kdsatker, thang) as b on a.kdkotama=b.kdkotama and a.kdsatker=b.kdsatker and a.thang=b.thang
where  a.kdkotama='$_SESSION[kdkotama]' and a.kdsatker='$_SESSION[kdsatker]' and a.thang='2024'
group by a.kdkotama, a.kdsatker, a.thang"); 
...
from blu a
left join (select kdkotama, kdsatker, thang, sum(realisasi) as realisasi  from realisasi_blu  where kdbulan<='12' and kdkotama='$_SESSION[kdkotama]' and kdsatker='$_SESSION[kdsatker]' and thang='2024' group by kdkotama, kdsatker, thang) as b on a.kdkotama=b.kdkotama and a.kdsatker=b.kdsatker and a.thang=b.thang
where  a.kdkotama='$_SESSION[kdkotama]' and a.kdsatker='$_SESSION[kdsatker]' and a.thang='2024'
group by a.kdkotama, a.kdsatker, a.thang"); 
...
from kapitasi a
left join (select kdkotama, kdsatker, thang, sum(realisasi) as realisasi  from realisasi_kapitasi  where kdbulan<='12' and kdkotama='$_SESSION[kdkotama]' and kdsatker='$_SESSION[kdsatker]' and thang='2024' group by kdkotama, kdsatker, thang) as b on a.kdkotama=b.kdkotama and a.kdsatker=b.kdsatker and a.thang=b.thang
where  a.kdkotama='$_SESSION[kdkotama]' and a.kdsatker='$_SESSION[kdsatker]' and a.thang='2024'
group by a.kdkotama, a.kdsatker, a.thang"); 
...
from hibah a
left join (select kdkotama, kdsatker, thang, sum(realisasi) as realisasi  from realisasi_hibah  where kdbulan<='12' and kdkotama='$_SESSION[kdkotama]' and kdsatker='$_SESSION[kdsatker]' and thang='2024' group by kdkotama, kdsatker, thang) as b on a.kdkotama=b.kdkotama and a.kdsatker=b.kdsatker and a.thang=b.thang
where  a.kdkotama='$_SESSION[kdkotama]' and a.kdsatker='$_SESSION[kdsatker]' and a.thang='2024'
group by a.kdkotama, a.kdsatker, a.thang"); 
...
$jml_sbsn=mysql_query("select a.kdkotama, a.kdsatker, a.thang, sum(a.pagu) as pagu,  sum(a.revisi) as revisi, sum(a.pagurevisi)  as pagurevisi, b.realisasi
from sbsn a
left join (select kdkotama, kdsatker, thang, sum(realisasi) as realisasi  from realisasi_sbsn  where kdbulan<='12' and kdkotama='$_SESSION[kdkotama]' and kdsatker='$_SESSION[kdsatker]' and thang='2024' group by kdkotama, kdsatker, thang) as b on a.kdkotama=b.kdkotama and a.kdsatker=b.kdsatker and a.thang=b.thang
where  a.kdkotama='$_SESSION[kdkotama]' and a.kdsatker='$_SESSION[kdsatker]' and a.thang='2024'
group by a.kdkotama, a.kdsatker, a.thang"); 
