...
$pagu51=mysql_query("select sum(pagurevisi) as pagurevisi from dipa where thang='2024' and kdjenbel='51' group by kdjenbel");
$x51    = mysql_fetch_array($pagu51);

$reals51=mysql_query("select sum(realisasi) as realisasi from realisasi where thang='2024' and kdjenbel='51' and kdbulan<='12' group by kdjenbel");
...
$pagu52=mysql_query("select sum(pagurevisi) as pagurevisi from dipa where thang='2024' and kdjenbel='52' group by kdjenbel");
$x52    = mysql_fetch_array($pagu52);

$reals52=mysql_query("select sum(realisasi) as realisasi from realisasi where thang='2024' and kdjenbel='52' and kdbulan<='12' group by kdjenbel");
...
$pagu53=mysql_query("select sum(pagurevisi) as pagurevisi from dipa where thang='2024'  and kdjenbel='53' group by kdjenbel");
$x53    = mysql_fetch_array($pagu53);

$reals53=mysql_query("select sum(realisasi) as realisasi from realisasi where thang='2024' and kdjenbel='53' and kdbulan<='12' group by kdjenbel");
...
// pagu dan realisasi--------------------------------------
$pg=mysql_query("select sum(pagu) as pagu, sum(revisi) as revisi, sum(pagurevisi) as pagurevisi from dipa where thang='2024'   group by  thang");
 $row1    = mysql_fetch_array($pg);
 
 $reals=mysql_query("select sum(realisasi) as realisasi from realisasi where thang='2024' and kdbulan<='12' group by  thang");
