...
from dipa a
left join (select kdkotama,  thang, sum(realisasi) as realisasi  from realisasix where kdkotama='$_SESSION[kdkotama]'  and thang='2024' group by kdkotama,  thang) as b on a.kdkotama=b.kdkotama  and a.thang=b.thang
where  a.kdkotama='$_SESSION[kdkotama]'  and a.thang='2024'
...
from yanmasum a
left join (select kdkotama,  thang, sum(realisasi) as realisasi  from realisasi_yanmasum where kdbulan<='12' and kdkotama='$_SESSION[kdkotama]' and thang='2024' group by kdkotama, thang) as b on a.kdkotama=b.kdkotama  and a.thang=b.thang
where  a.kdkotama='$_SESSION[kdkotama]'  and a.thang='2024'
group by a.kdkotama, a.thang"); 
...
from bpjs a
left join (select kdkotama,  thang, sum(realisasi) as realisasi  from realisasi_bpjs where kdbulan<='12' and kdkotama='$_SESSION[kdkotama]' and thang='2024' group by kdkotama, thang) as b on a.kdkotama=b.kdkotama  and a.thang=b.thang
where  a.kdkotama='$_SESSION[kdkotama]'  and a.thang='2024'
group by a.kdkotama, a.thang"); 
...
from blu a
left join (select kdkotama,  thang, sum(realisasi) as realisasi  from realisasi_blu where kdbulan<='12' and kdkotama='$_SESSION[kdkotama]' and thang='2024' group by kdkotama, thang) as b on a.kdkotama=b.kdkotama  and a.thang=b.thang
where  a.kdkotama='$_SESSION[kdkotama]'  and a.thang='2024'
group by a.kdkotama, a.thang"); 
...
from kapitasi a
left join (select kdkotama,  thang, sum(realisasi) as realisasi  from realisasi_kapitasi where kdbulan<='12' and kdkotama='$_SESSION[kdkotama]' and thang='2024' group by kdkotama, thang) as b on a.kdkotama=b.kdkotama  and a.thang=b.thang
where  a.kdkotama='$_SESSION[kdkotama]'  and a.thang='2024'
group by a.kdkotama, a.thang"); 
...
from hibah a
left join (select kdkotama,  thang, sum(realisasi) as realisasi  from realisasi_hibah where kdbulan<='12' and kdkotama='$_SESSION[kdkotama]' and thang='2024' group by kdkotama, thang) as b on a.kdkotama=b.kdkotama  and a.thang=b.thang
where  a.kdkotama='$_SESSION[kdkotama]'  and a.thang='2024'
group by a.kdkotama, a.thang"); 
...
from sbsn a
left join (select kdkotama,  thang, sum(realisasi) as realisasi  from realisasi_sbsn where kdbulan<='12' and kdkotama='$_SESSION[kdkotama]' and thang='2024' group by kdkotama, thang) as b on a.kdkotama=b.kdkotama  and a.thang=b.thang
where  a.kdkotama='$_SESSION[kdkotama]'  and a.thang='2024'
group by a.kdkotama, a.thang"); 
