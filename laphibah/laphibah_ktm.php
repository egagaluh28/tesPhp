...
class JinPagination {
	...
	function build() {
		...
		$query = mysql_query("select z.* from (select a.*, b.nmsatkr from laphibah a left join t_satkr b on a.kdkotama=b.kdkotama and a.kdsatker=b.kdsatkr where a.kdkotama='$_SESSION[kdkotama]' and a.thang='$_GET[thang]') as z ".$where."");
		...
		// Get data.
		$query = "select z.* from (select a.*, b.nmsatkr from laphibah a left join t_satkr b on a.kdkotama=b.kdkotama and a.kdsatker=b.kdsatkr where a.kdkotama='$_SESSION[kdkotama]'  and a.thang='$_GET[thang]') as z  ".$where." ".$order." LIMIT ".$start.", ".$limit."";
...
$hal->setOption("order", "ORDER BY z.kdkotama, z.tgl_nph"); // urutan, kosongkan jika tidak memakai urutan
