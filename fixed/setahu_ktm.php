...
group by   a.kdakun order by  a.kdakun) as z on x.kdakun=z.kdakun group by x.kdakun";
 ...
 print "<table width='97%' align='center'><tr>
				...
				*/
	            print "<a href='cetak/cetak_akungaji_kotama_tahunan.php?thang=$_GET[thang]&kdkotama=$_SESSION[kdkotama]&kdsatker=$_SESSION[kdsatker]' target='_blank' style='text-decoration:none'><input  type='button' value='&nbsp;&nbsp;Cetak&nbsp;&nbsp;' /></a>&nbsp;&nbsp;
				<a href='convert/wasgaji_ktm.php?thang=$_GET[thang]&kdkotama=$_SESSION[kdkotama]' target='_blank' style='text-decoration:none'><input  type='button' value='Export Ke Excel' /></a>
				</div></td>";
				print "</tr></table><br>";
?> 		
