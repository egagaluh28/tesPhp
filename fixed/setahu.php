...
group by   a.kdakun order by  a.kdakun) as z on x.kdakun=z.kdakun group by x.kdakun";
 ...
 print "<table width='97%' align='center'><tr>
				...
				*/
				...
				<a href='convert/wasgaji.php?thang=$_GET[thang]&kdkotama=$_GET[kdkotama]&kdsatker=$_GET[kdsatker]' target='_blank' style='text-decoration:none'><input  type='button' value='Export Ke Excel' /></a>
				</div></td>";
				print "</tr></table><br>";
?> 		
