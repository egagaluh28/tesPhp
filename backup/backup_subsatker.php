...
<br><center><span class='judulcontent'>BACKUP DATA SUB SATKER </span></center><br>
...
//	$file='Backup'.'_'.date("dmY").'_'.date('His').'_'.$nama1.'.sql';
	$file='Backup_Sub'.'_'.date("dmY").'_'.date('His').'_'.$nama1.'_'.$nama2.'.sql';
//	$file=date("dmY").'_'.'watzah'.'_'.time().'.sql';
	...
	<p align="center"><img src="images/berhasil.gif" height="200"></a></p>
    <p align="center"><a style="cursor:pointer" onclick="location.href='backup/download_backup_data1.php?nama_file=<?php echo $file;?>'" title="Download"><div class='hovergallery'><center><img src="images/donlod.png" width="200"></center></div></a>
	<?php
}else{
	unset($_POST['backup']);
}
...
function backup_tables($host,$user,$pass,$name,$nama_file,$tables = 'pagu,dipa,bpjs, yanmasum,realisasi,p3,npb,spp,pengembalian,tunkin,kopstuk,tajuk_ttd,lamp_laplakgar')
