...
<body>
<br><center><span class='judul'>RESTORE DATA KOTAMA</span></center><br>
<center><div id="border__">
<img src="images/restore.png" width="220">
<form enctype="multipart/form-data" action="media.php?module=restore_ktm" method="post">
	
	
	<table align="center">
	<tr><td class="subyek1">File Backup  (*.sql) <input type="file" name="datafile" size="30" id="gambar" class="sendiri"/></td></tr>
