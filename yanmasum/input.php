...
?>
   ...
   <form  name="form1" method="POST"  action="yanmasum/proses.php?aksi=simpan" >
   
			<table  width='97%' align='center'   cellpadding='3'  >
			
			<tr>
				 <td  valign="middle" class="subyek1" align="right" >TAHUN ANGGARAN : </td>
				 <td  valign="middle"><? print "<select name='thang' class='select-field'>";
			...
			<tr>
				 ...
				 <td  valign="middle" >  <input type="text"  name="kdkotama"  size="7" class="input-field" readonly value=<? print "$row[kdkotama]"; ?> 
			...
			<tr>
				 ...
				 <td   >  <input type="text"  name="kdsatker"  size="7" class="input-field" readonly value=<? print "$row[kdsatkr]"; ?> 
				 style="text-align: center;" />&nbsp;&nbsp;<span class="subyek1"><? print "$row[nmsatkr]"; ?></span>
				 </td>	

				
				<td  valign="middle" class="subyek1" align="right" >KU SATKER :</td>  
				<td  valign="middle" ><input type="text"  name="kdkusatker"  class="input-field" size="7" readonly style="text-align: center;" value=<? print "$row[kdkusatker]"; ?> />&nbsp;&nbsp;<span class="subyek1"><? print "$row[nmkusatker]"; ?></span></td></tr>
			...
			<tr><td><div class="suggestionsBox" id="suggestions" style="display: none;"> <img src="yanmasum/arrow.png" style="position: relative; top: -10px; left: 30px;" alt="upArrow" />
...
function suggest(inputString){
	...
	$('#kodespa').addClass('load');
		$.post("yanmasum/proses_cari_autosuggest.php", {queryString: ""+inputString+""}, function(data){
			if(data.length >0) {
				$('#suggestions').fadeIn();
