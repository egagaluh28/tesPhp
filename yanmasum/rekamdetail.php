...
<?
  ...
  $detail = mysql_query("SELECT a.*, b.nmkotama, c.nmsatkr, d.nmkusatker from yanmasum a left join t_kotam b on a.kdkotama=b.kdkotama
...
$sql_rec="SELECT MAX(noitem) + 1 AS id_baru1 FROM yanmasum where kdprogram ='$_GET[kdprogram]' and
...
$sql_norut="SELECT MAX(noitem) + 1 AS norut_baru FROM yanmasum where kdprogram ='$_GET[kdprogram]' and
																	kdgiat    ='$_GET[kdgiat]' and
																    kdoutput  ='$_GET[kdoutput]' and
																    kdakun    ='$_GET[kdakun]' and
																    kdsakun   ='$_GET[kdsakun]' and
