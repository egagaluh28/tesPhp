...
print "<br><table  width='1100' align='center' ><tr><td class='judulcontent' align='center'>REKAP PAGU - YANMASUM $_GET[thang]</td></tr></table><br>";	

$query= "SELECT '' as id_pagu,  kdwasgiat,   thang, '' as kode, '1' as display,  'YANMASUM' as uraian, sum(pagu) as pagu, sum(revisi) as revisi, sum(pagurevisi) as pagurevisi
FROM yanmasum where thang='$_GET[thang]' 
group by  thang
