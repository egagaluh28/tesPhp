...
#borderku{
 ...
 <br>
 <br><table  width='1200' align='center' ><tr><td class='judulcontent' align='center'>AKUN GAJI KOTAMA</td></tr></table>

 <br><center><div id="borderku" >
 <?
 print "<form name='form1' method='GET'  action='paban4/kirimparameter_ktm.php' >";
	print "<table width='99%'  cellspacing='0' cellpadding='2' align='center'><tr><td class='subyek1' align='center'>";

			print "KOTAMA : <select name='kdkotama'   class='rounded'  >
