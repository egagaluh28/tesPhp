...
#borderku{
 ...
 <br>
 <br><table  width='1200' align='center' ><tr><td class='judulcontent' align='center'>AKUN GAJI SATKER</td></tr></table>

 <br><center><div id="borderku" >
 <?
 print "<form name='form1' method='GET'  action='akungaji/kirimparameter.php' >";
