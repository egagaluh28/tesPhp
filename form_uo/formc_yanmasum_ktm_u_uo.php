...
#borderku{
 ...
 <?
 print "<form name='form1' method='GET'  action='cetak/cetak_yanmasum_ktm.php' target='_Blank'>";
 print "<table width='99%'  cellspacing='0' cellpadding='2' align='center'><tr><td class='subyek1' align='center'>";
	print "KOTAMA : <select name='kdkotama'  class='select-field' required='required' >";
