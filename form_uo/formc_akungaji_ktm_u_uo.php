...
font-family: Cambria, Palatino, "Palatino Linotype", "Palatino LT STD", Georgia, serif;
 ...
 <center><br><span class='judulcontent'>CETAK LAP PENGAWASAN GAJI & TUNKIN TINGKAT KOTAMA</span></center><br><br>
 
 <center>
 <?
  print "<div id='borderku' ><div class='form-style-2'>";
 print "<form name='form1' method='GET'  action='cetak/cetak_akungaji_ktm.php' target='_blank'>";
