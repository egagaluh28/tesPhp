...
#borderku{
 ...
 <br>
 <br><table  width='1100' align='center' ><tr><td class='judulcontent' align='center'>CETAK DIPA DAERAH (PNBP YANMASUM) TINGKAT UO</td></tr></table>

 <br><center><div id="borderku" >
 <div class="form-style-2">
 <?
 print "<form name='form1' method='GET'  action='cetak/cetak_yanmasum_uo.php' target='_Blank'>";
