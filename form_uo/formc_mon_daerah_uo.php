...
#borderku{
 ...
 <br>
 <br><table  width='1100' align='center' ><tr><td class='judulcontent' align='center'>CETAK MONITORING DIPA DAERAH TINGKAT UO</td></tr></table>
 ...
 print "<form name='form1' method='GET'  action='cetak/cetak_mon_daerah_uo.php' target='_Blank'>";
	...
	print "<div class='codehim-tombol-biru'><table width='65%'  cellspacing='0' cellpadding='2' align='center'><tr><td class='subyek1'>BULAN : ";
