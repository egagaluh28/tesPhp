...
#borderku{
 ...
 <br>
 <br><table  width='1100' align='center' ><tr><td class='judulcontent' align='center'>CETAK DIPA DAERAH TINGKAT UO</td></tr></table>

 <br><center><div id="borderku" ><div class='form-style-2'>
 <?
 print "<form name='form1' method='GET'  action='cetak/cetak_daerah_uo_jenbel.php' target='_Blank'>";

	print "<table width='80%'  cellspacing='0' cellpadding='2' align='center'><tr><td class='subyek1'><div class='codehim-tombol-biru'>BULAN : ";
