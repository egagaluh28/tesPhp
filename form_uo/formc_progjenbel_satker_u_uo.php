...
$(document).ready(function(){
 ...
 <center><br><span class='judulcontent'>CETAK PAGU DAN REALISASI PER PROG/JENBEL TKT SATKER</span></center><br><br>
 
 <center>
 <?
  print "<div id='borderku' ><div class='form-style-2'>";
 print "<form name='form1' method='GET'  action='cetak/cetak_progrealisasi_satker.php' target='_blank'>";
	...
	print "&nbsp;&nbsp&nbsp<input  type='submit' value='Cetak' class='button blue'/></td>";
