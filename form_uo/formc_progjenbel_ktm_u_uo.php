...
font-family: Cambria, Palatino, "Palatino Linotype", "Palatino LT STD", Georgia, serif;
 ...
 <center><br><span class='judulcontent'>CETAK PAGU DAN REALISASI PER PROG/JENBEL TKT KOTAMA</span></center><br><br>
 
 <center>
 <?
  print "<div id='borderku' ><div class='form-style-2'>";
 print "<form name='form1' method='GET'  action='cetak/cetak_progrealisasi_ktm.php' target='_blank'>";
