...
#borderku{
 ...
 <br>
 <br><table  width='1100' align='center' ><tr><td class='judulcontent' align='center'>REALISASI ANGGARAN PER WASGIAT</td></tr></table>

 <br><center><div id="borderku" ><div class='form-style-2'>
 <?
 print "<form name='form1' method='GET'  action='realisasi/kirimparameter_uo_wasgiat.php' >";
	print "<table width='90%'  cellspacing='0' cellpadding='2' align='center'><tr><td class='subyek1'>WASGIAT : ";
