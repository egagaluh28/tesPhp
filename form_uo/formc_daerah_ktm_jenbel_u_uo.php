...
#borderku{
 ...
 <br><table  width='1100' align='center' ><tr><td class='judulcontent' align='center'>CETAK  DIPA PETIKAN SATKER TINGKAT KOTAMA</td></tr></table>

 <br><center><div id="borderku" >
 <div class="form-style-2">
 <?
 print "<form name='form1' method='GET'  action='cetak/cetak_daerah_ktm_jenbel.php' target='_Blank'>";
...
<br><table  width='1100' align='center' ><tr><td class='judulcontent' align='center'>CETAK  DIPA PETIKAN SATKER TINGKAT KOTAMA (PLUS SBSN)</td></tr></table>

 <br><center><div id="borderku" >
 <div class="form-style-2">
 <?
 print "<form name='form1' method='GET'  action='cetak/cetak_daerah_ktm_jenbel_sbsn.php' target='_Blank'>";
