<?
    $edit = mysql_query("SELECT * from validitas where id_validitas='$_GET[id_validitas]'");
    $row    = mysql_fetch_array($edit);
 
    $ktm = mysql_query("SELECT * from t_kotam where kdkotama='$row[kdkotama]'");
    $k    = mysql_fetch_array($ktm);
	
	$satkr = mysql_query("SELECT * from t_satkr where kdkotama='$row[kdkotama]' and kdsatkr='$row[kdsatker]'");
    $s    = mysql_fetch_array($satkr);
?>	
<br>
<center><span class="judul">EDIT VALIDITAS</span></center><br>
 <center><div id="borderku1" >
<form action="validitas/prosesvaliditassatker.php?aksi=ubah_utk_uo" method="POST"  name="form1">  
    ...
    <table width="800" align="center" cellpadding="5">
			...
			<tr>
				...
				<input name="kdkotama" type="text"  size="4" class="roundedisi" readonly  value="<? print "$row[kdkotama]"; ?>" />&nbsp;
			...
			<tr>
			    ...
			    <td valign="top" colspan="3">
				<input name="kdsatker" type="text"  size="4" class="roundedisi" readonly  value="<? print "$row[kdsatker]"; ?>" />&nbsp;
			...
			<tr>
				...
				<td valign="top" ><select name="b01" class="rounded"  >
										<option value="" selected>- Pilih -</option>
												<?
												if ($row['b01'] == "x") echo "<option value='x' selected>Selesai</option>";
												else echo "<option value='x'>Selesai</option>";
												if ($row['b01'] == "y") echo "<option value='y' selected>Blm Selesai</option>";
			...
			<td width="150" align="right" class="subyek1">JULI :</td>
				<td valign="top" ><select name="b07" class="rounded"  >
										<option value="" selected>- Pilih -</option>
												<?
												if ($row['b07'] == "x") echo "<option value='x' selected>Selesai</option>";
												else echo "<option value='x'>Selesai</option>";
												if ($row['b07'] == "y") echo "<option value='y' selected>Blm Selesai</option>";
												else echo "<option value='y'>Blm Selesai</option>"; 
												?>
										</select></td>
			</tr>
			...
			<tr>
				...
				<td valign="top" ><select name="b02" class="rounded"  >
										<option value="" selected>- Pilih -</option>
												<?
												if ($row['b02'] == "x") echo "<option value='x' selected>Selesai</option>";
												else echo "<option value='x'>Selesai</option>";
												if ($row['b02'] == "y") echo "<option value='y' selected>Blm Selesai</option>";
												else echo "<option value='y'>Blm Selesai</option>"; 
												?>
										</select></td>
				...
				<td valign="top" ><select name="b08" class="rounded"  >
										<option value="" selected>- Pilih -</option>
												<?
												if ($row['b08'] == "x") echo "<option value='x' selected>Selesai</option>";
												else echo "<option value='x'>Selesai</option>";
												if ($row['b08'] == "y") echo "<option value='y' selected>Blm Selesai</option>";
												else echo "<option value='y'>Blm Selesai</option>"; 
												?>
										</select></td>
			</tr>
			...
			<tr>
				...
				<td valign="top" ><select name="b03" class="rounded"  >
										<option value="" selected>- Pilih -</option>
												<?
												if ($row['b03'] == "x") echo "<option value='x' selected>Selesai</option>";
												else echo "<option value='x'>Selesai</option>";
												if ($row['b03'] == "y") echo "<option value='y' selected>Blm Selesai</option>";
												else echo "<option value='y'>Blm Selesai</option>"; 
												?>
										</select></td>
			<td width="150" align="right" class="subyek1">SEPTEMBER :</td>
				<td valign="top" ><select name="b09" class="rounded"  >
										<option value="" selected>- Pilih -</option>
												<?
												if ($row['b09'] == "x") echo "<option value='x' selected>Selesai</option>";
												else echo "<option value='x'>Selesai</option>";
												if ($row['b09'] == "y") echo "<option value='y' selected>Blm Selesai</option>";
												else echo "<option value='y'>Blm Selesai</option>"; 
												?>
										</select></td>
			</tr>
			...
			<tr>
				...
				<td valign="top" ><select name="b04" class="rounded"  >
										<option value="" selected>- Pilih -</option>
												<?
												if ($row['b04'] == "x") echo "<option value='x' selected>Selesai</option>";
												else echo "<option value='x'>Selesai</option>";
												if ($row['b04'] == "y") echo "<option value='y' selected>Blm Selesai</option>";
												else echo "<option value='y'>Blm Selesai</option>"; 
												?>
										</select></td>
			...
			<td width="150" align="right" class="subyek1">OKTOBER :</td>
				<td valign="top" ><select name="b10" class="rounded"  >
										<option value="" selected>- Pilih -</option>
												<?
												if ($row['b10'] == "x") echo "<option value='x' selected>Selesai</option>";
												else echo "<option value='x'>Selesai</option>";
												if ($row['b10'] == "y") echo "<option value='y' selected>Blm Selesai</option>";
												else echo "<option value='y'>Blm Selesai</option>"; 
												?>
										</select></td>
			</tr>
			...
			<tr>
				...
				<td valign="top" ><select name="b05" class="rounded"  >
										<option value="" selected>- Pilih -</option>
												<?
												if ($row['b05'] == "x") echo "<option value='x' selected>Selesai</option>";
												else echo "<option value='x'>Selesai</option>";
												if ($row['b05'] == "y") echo "<option value='y' selected>Blm Selesai</option>";
												else echo "<option value='y'>Blm Selesai</option>"; 
												?>
										</select></td>
			<td width="150" align="right" class="subyek1">NOPEMBER :</td>
				<td valign="top" ><select name="b11" class="rounded"  >
										<option value="" selected>- Pilih -</option>
												<?
												if ($row['b11'] == "x") echo "<option value='x' selected>Selesai</option>";
												else echo "<option value='x'>Selesai</option>";
												if ($row['b11'] == "y") echo "<option value='y' selected>Blm Selesai</option>";
												else echo "<option value='y'>Blm Selesai</option>"; 
												?>
										</select></td>
			</tr>
			...
			<tr>
				...
				<td valign="top" ><select name="b06" class="rounded"  >
										<option value="" selected>- Pilih -</option>
												<?
												if ($row['b06'] == "x") echo "<option value='x' selected>Selesai</option>";
												else echo "<option value='x'>Selesai</option>";
												if ($row['b06'] == "y") echo "<option value='y' selected>Blm Selesai</option>";
												else echo "<option value='y'>Blm Selesai</option>"; 
												?>
										</select></td>
				...
				<td valign="top" ><select name="b12" class="rounded"  >
										<option value="" selected>- Pilih -</option>
												<?
												if ($row['b12'] == "x") echo "<option value='x' selected>Selesai</option>";
												else echo "<option value='x'>Selesai</option>";
												if ($row['b12'] == "y") echo "<option value='y' selected>Blm Selesai</option>";
												else echo "<option value='y'>Blm Selesai</option>"; 
												?>
										</select></td>
			</tr>									
