...
<?
 $edit = mysql_query("SELECT a.kdkotama,  a.kdsatkr, a.nmsatkr, a.kdkusatker, b.nmkotama from t_satkr a 
  ...
  print "<br><table  width='1100' align='center' ><tr><td class='judulcontent' align='center'>KARTU WASGAR RUPIAH MURNI</td></tr></table><br>";
  
  ?>  
	<center><div id="borderku" >
				<div class="form-style-2">	
   <form name="form1"  method="GET" action="wasgar/cetakwasgar_daerah_satker.php" target="_blank">
