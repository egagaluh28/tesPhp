...
<?
 $edit = mysql_query("SELECT  * from t_kotam a  where kdkotama='$_SESSION[kdkotama]' ");
  ...
  print "<br><table  width='1100' align='center' ><tr><td class='judulcontent' align='center'>KARTU WASGAR YANMASUM KOTAMA</td></tr></table><br>";
  
  ?>  
	<center><div id="borderku" >
				<div class="form-style-2">	
   <form name="form1"  method="GET" action="wasgar/cetakwasgar_yanmasum_ktm.php" target="_blank">
