...
print "<br><table  width='1100' align='center' ><tr><td class='judulcontent' align='center'>REKAP PAGU - DIPA DAERAH $_GET[thang]</td></tr></table><br>";	

$query= "SELECT '' as id_pagu,  kdwasgiat, kdkotama,  thang, '' as kode, '1' as display,  'RUPIAH MURNI' as uraian, sum(pagu) as pagu, sum(revisi) as revisi, sum(pagurevisi) as pagurevisi
FROM dipa where  kdkotama='$_SESSION[kdkotama]' and thang='$_GET[thang]' 
group by kdkotama, thang
union (SELECT '' as id_pagu, a.kdwasgiat, a.kdkotama,   a.thang, concat('012.','22.',a.kdprogram) as kode, concat('1',a.kdprogram) as display, b.nmprogram as uraian, sum(a.pagu) as pagu, sum(a.revisi) as revisi, sum(a.pagurevisi) as pagurevisi 
FROM dipa a 
...
union (SELECT '' as id_pagu, a.kdwasgiat, a.kdkotama,   a.thang, a.kdgiat as kode, concat('1',a.kdprogram,a.kdgiat) as display, b.nmgiat as uraian, sum(a.pagu) as pagu, sum(a.revisi) as revisi, sum(a.pagurevisi) as pagurevisi 
FROM dipa a 
left join t_giat b on a.kdgiat=b.kdgiat
where  a.kdkotama='$_SESSION[kdkotama]'  and a.thang='$_GET[thang]' 
group by a.kdprogram, a.kdgiat)
union (SELECT '' as id_pagu, a.kdwasgiat, a.kdkotama,   a.thang, a.kdoutput as kode, concat('1',a.kdprogram,a.kdgiat,a.kdoutput) as display, b.nmoutput as uraian, sum(a.pagu) as pagu, sum(a.revisi) as revisi, sum(a.pagurevisi) as pagurevisi 
FROM dipa a 
...
union (SELECT '' as id_pagu,  kdwasgiat, kdkotama, thang, kdakun as kode, concat('1',kdprogram,kdgiat,kdoutput,kdakun) as display, nmakun as uraian,  
...
union (SELECT '' as id_pagu,  kdwasgiat, kdkotama, thang, '' kode, concat('1',kdprogram,kdgiat,kdoutput,kdakun, kdsakun) as display, concat('- ',nmsakun) as uraian,  
sum(pagu) as pagu, sum(revisi) as revisi, sum(pagurevisi) as pagurevisi 
FROM dipa 
where  kdkotama='$_SESSION[kdkotama]' and thang='$_GET[thang]' 
