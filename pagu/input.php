...
$id_baru1=1;
  ...
  /*  $edit = mysql_query("SELECT a.kdkotama,  a.kdsatkr, a.nmsatkr,  b.nmkotama from t_satkr a 
  left join t_kotam b on a.kdkotama=b.kdkotama 
  where a.kdkotama='$_GET[kdkotama]' and a.kdsatkr='$_GET[kdsatker]'");*/
  $row    = mysql_fetch_array($edit);
  
  $nmkotama = strtoupper($row[nmkotama]);
