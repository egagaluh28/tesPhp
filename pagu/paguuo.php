...
$query= "SELECT '' as id_pagu,  kdwasgiat,   thang, '' as kode, '1' as display,  'RUPIAH MURNI' as uraian, sum(pagu) as pagu, sum(revisi) as revisi, sum(pagurevisi) as pagurevisi
FROM dipa where thang='$_GET[thang]' 
group by  thang
