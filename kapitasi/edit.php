...
print "<br><table  width='1100' align='center' ><tr><td class='judulcontent' align='center'>EDIT DATA PAGU</td></tr></table><br>";
    ...
    $edit = mysql_query("SELECT  a.*,  d.nmwasgiat,  f.nmprogram, g.nmgiat, h.nmoutput,
						 i.nmakun, j.nmsakun, k.nmkotama, l.nmsatkr,  nmkusatker from kapitasi a 
...
?>
   ...
   <form  name="form1" method="POST"  action="kapitasi/proses.php?aksi=ubah" >
		...
		<div id="suggest">
			<tr><td class="subyek1" align="right">FUNGSI :</td>
