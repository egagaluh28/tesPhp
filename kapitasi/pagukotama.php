...
print "<br><table  width='1100' align='center' ><tr><td class='judulcontent' align='center'>REKAP PAGU - KAPITASI $_GET[thang]</td></tr></table><br>";	

$query= "SELECT '' as id_pagu,  '' as kdprogram, kdwasgiat, kdkotama,  thang, '' as kode, '1' as display,  'KAPITASI' as uraian, sum(pagu) as pagu, sum(revisi) as revisi, sum(pagurevisi) as pagurevisi
FROM kapitasi where  kdkotama='$_SESSION[kdkotama]' and thang='$_GET[thang]' 
group by kdkotama, thang

union (SELECT '' as id_pagu, '' as kdprogram, a.kdwasgiat, a.kdkotama,  a.thang, concat('012.','22.',a.kdprogram) as kode, concat('1',a.kdprogram) as display, b.nmprogram as uraian, sum(a.pagu) as pagu, sum(a.revisi) as revisi, sum(a.pagurevisi) as pagurevisi FROM kapitasi a 
