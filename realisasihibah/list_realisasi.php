...
//        pakai ini
            ...
            $reload = "media.php?module=list_realisasi_hibah&thang=$_GET[thang]&pagination=true&keyword=$keyword";
            $result =  mysql_query("select z.* from(SELECT a.*, b.nmbulan, c.nmwasgiat from realisasi_hibah a 
...
//            jika tidak ada pencarian pakai ini
            $reload = "media.php?module=list_realisasi_hibah&thang=$_GET[thang]&pagination=true";
            $result =  mysql_query("SELECT a.*, b.nmbulan, c.nmwasgiat from realisasi_hibah a 
			left join t_bulan b on a.kdbulan=b.kdbulan  
...
<table  width='98%' align='center'>
    <tr>
		...
		<td align="right">
			...
			<a href="<?php print "media.php?module=list_realisasi_hibah&thang=$_GET[thang]"; ?>"
 ...
 ?>             
					...
					<tr>
						...
						<td valign="top"><?php print $data['nmbulan']?></a> </td>
							...
							<td valign="top" align="center"><?php print "<a href=\"realisasihibah/proses.php?aksi=hapusrealisasi&id_realisasi=$data[id_realisasi]&thang=$_GET[thang]\" 
