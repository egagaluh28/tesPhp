...
<?
		 $qry = mysql_query("select * from renbut where aidi='$_GET[aidi]' ");
		 $x    = mysql_fetch_array($qry);
		 
		$all	 = number_format($x[jandes],0,',','.');
		$g13  = number_format($x[gaji13],0,',','.');
		$g14  = number_format($x[gaji14],0,',','.');
...
<br>
<center><span class="judulcontent">EDIT RENBUT GAJI DAN TUNKIN</span></center><br>
<center><div id="bdr">
<div class="form-style-2">
<form action="renbut/proses.php?aksi=ubah" method="POST"  name="form1">  
<input name="kdbulan" type="hidden"  size="40" class="sendiri" value="<?php echo "$_GET[kdbulan]"; ?>"  />
    ...
    <table width="650" align="center" cellpadding="5">
			...
			<tr>
				...
				<td><input name="thang" type="text"   class="sendiri" value="<?php echo "$_GET[thang]"; ?>"  style="width: 400px;"/></td>
		    </tr>
			...
			<input type="hidden" class="sendiri" name="nmakun"    id="nmakun" value="<? echo "$x[nmakun]"; ?>">
			...
			<tr>
				...
				<td valign="top" ><? print "<input name='jandes' type='hidden'  value='$x[jandes]' class='sendiri' style='text-align: right;' />
					  ...
					  onkeyup='formatJandes(this);replaceJandes(document.form1.jandes_awal.value);' 
					   value='$all' class='sendiri' >"; ?></td>
			</tr>
			
			<tr>
				<td  align="right" class="subyek1">GAJI KE 13 :</td>
				<td valign="top" ><? print "<input name='gaji13' type='hidden'  value='$x[gaji13]' class='sendiri' style='text-align: right;' />
					  ...
					  onkeyup='formatGaji13(this);replaceGaji13(document.form1.gaji13_awal.value);' 
					   value='$g13' class='sendiri' >"; ?></td>
			</tr>
			
			<tr>
				<td  align="right" class="subyek1">GAJI KE 14 :</td>
				<td valign="top" ><? print "<input name='gaji14' type='hidden'  value='$x[gaji14]' class='sendiri' style='text-align: right;' />
					  ...
					  onkeyup='formatGaji14(this);replaceGaji14(document.form1.gaji14_awal.value);' 
					   value='$g14' class='sendiri' >"; ?></td>
			</tr>
			
			<tr>
				<td  align="right" class="subyek1">KETERANGAN :</td>
				<td valign="top" ><input name="ket" type="text" style='width: 400px'; class="sendiri" value="<?php echo $x[ket]; ?>"/>
		    </tr>
			
			
			<input name="aidi" type="hidden" style='width: 400px'; class="sendiri" value="<?php echo $x[aidi]; ?>"/>
